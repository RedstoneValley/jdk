 ...
 * alt="Diagram of virtual device encompassing three physical screens and one primary physical
 * screen. The primary physical screen
...
public class Frame extends Window {
   ...
   *                                        {@code false}, and this frame does not have the
   *                                        default shape
   * @throws IllegalComponentStateException if {@code undecorated} is
   *                                        {@code false}, and this frame opacity is less than
   *                                        {@code 1.0f}
   * @throws IllegalComponentStateException if {@code undecorated} is
   *                                        {@code false}, and the alpha value of this frame
   *                                        background
   ...
   * @throws OptionalDataException if an icon {@code Image}
   *                               is not available, but anything other than an EOF
   *                               is detected
