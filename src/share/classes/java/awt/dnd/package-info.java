 ...
 * <UL>
 * <LI>A {@code DragSource} comes into existence,
 * associated with some presentation
 * element ({@code Component}) in the GUI, to initiate a Drag and Drop of
 * some potentially {@code Transferable} data.
 * <br><br>
 * <LI>1 or more {@code DropTarget}(s) come into/go out of
 * existence, associated
 * with presentation elements in the GUI (Components), potentially
 * capable of consuming {@code Transferable} data types.
 * <br><br>
 * <LI> A {@code DragGestureRecognizer} is
 * obtained from the {@code DragSource} and is
 * associated with a {@code Component} in order
 * to track and identify any Drag
 * initiating gesture by the user over the {@code Component}.
 * <br><br>
 * <LI> A user makes a Drag gesture over the {@code Component},
 * which the registered
 * {@code DragGestureRecognizer} detects, and notifies its
 ...
 * particular {@code Component} class semantics.
 * <br><br>
 * <LI> The {@code DragGestureListener} causes the
 * {@code DragSource} to initiate the Drag
 * and Drop operation on behalf of the user, perhaps animating the
 * GUI Cursor and/or rendering an {@code Image} of the item(s) that are the
 * subject of the operation.
 * <br><br>
 * <LI> As the user gestures navigate over {@code Component}(s)
 * in the GUI with
 * associated {@code DropTarget}(s), the {@code DragSource}
 * receives notifications in order
 * to provide "Drag Over" feedback effects, and the {@code DropTarget}(s)
 ...
 * leaving {@code Component}(s) and associated {@code DropTarget}(s).
 * <p>
 * The {@code DragSource} object manifests "Drag Over" feedback to the user, in the typical
 * case by animating the GUI {@code Cursor} associated with the
 * logical cursor.
 * <p>
 * {@code DropTarget} objects manifest "Drag Under" feedback to the user, in
 ...
 * both the {@code DragSource} and {@code DropTarget}: Copy, Move or Reference(link).
 * <br><br>
 ...
 * transfer of, the information associated with the {@code DragSource} via a
