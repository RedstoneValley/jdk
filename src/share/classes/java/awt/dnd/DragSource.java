...
public class DragSource implements Serializable {
   ...
   *                                      system is unable to initiate a drag
   *                                      operation, or if the user
   ...
   * @param dragCursor   the initial {@code Cursor} for this drag operation
   *                     or {@code null} for the default cursor handling;
   *                     see <a href="DragSourceContext.html#defaultCursor">DragSourceContext
   *                     </a> class
   *                     for more details on the cursor handling mechanism during drag and drop
   * @param transferable the subject data of the drag
   * @param dsl          the {@code DragSourceListener}
   ...
   *                                  {@code null} and {@code imageOffset} is
   *                                  {@code null}
   ...
   *                                  {@code DragGestureRecognizer} associated with the
   *                                  trigger
   ...
   * operations intiated with this {@code DragSource}.
