...
public class DataFlavor implements Externalizable, Cloneable {
  ...
  /**
   * The {@code DataFlavor} representing a Java Unicode String class,
   * where:
   * <pre>
   ...
   *
   * @deprecated as of 1.3. Use {@code DataFlavor.getReaderForText(Transferable)}
   * instead of {@code Transferable.getTransferData(DataFlavor.plainTextFlavor)}.
   */
   ...
   * from an invocation {@code java.awt.datatransfer.getTransferData}.
   */
  public static final String javaSerializedObjectMimeType = "application/x-java-serialized-object";
  /**
   * To transfer a list of files to/from Java (and the underlying
   * platform) a {@code DataFlavor} of this type/subtype and
   * representation class of {@code java.util.List} is used.
   ...
   * has no associated MIME Content-type, across a {@code Transferable}
   * interface WITHIN THE SAME JVM, a {@code DataFlavor}
   * with this type/subtype is used, with a {@code representationClass}
   * equal to the type of the class/interface being passed across the
   * {@code Transferable}.
   * <p>
   * The object reference returned from
   * {@code Transferable.getTransferData} for a {@code DataFlavor}
   * with this MIME Content-Type is required to be
   * an instance of the representation Class of the {@code DataFlavor}.
   */
   ...
   * where the representation class of the {@code DataFlavor}
   * represents the type of the {@code Remote} interface to be
   * transferred.
   */
  ...
  /**
   * Constructs a new {@code DataFlavor}.  This constructor is
   * provided only for the purpose of supporting the
   * {@code Externalizable} interface.  It is not
   ...
   *                              {@code subType} or {@code representationClass} is null
   */
  private DataFlavor(
   ...
   * <p>
   * The returned {@code DataFlavor} will have the following
   * characteristics:
   * <pre>
   ...
   *                             this flavor; if this parameter is {@code null}
  ...
  /**
   * Constructs a {@code DataFlavor} that represents a
   * {@code MimeType}.
   * <p>
   * The returned {@code DataFlavor} will have the following
   * characteristics:
   ...
   *                             if the the {@code mimeType} does not specify a
   *                             "class=" parameter, or if the class is not successfully
   *                             loaded, then an {@code IllegalArgumentException}
   *                             is thrown
   * @param humanPresentableName the human-readable string used to identify
   *                             this flavor; if this parameter is {@code null}
   *                             then the value of the the MIME Content Type is used
  ...
  /**
   * Constructs a {@code DataFlavor} from a {@code mimeType} string.
   * The string can specify a "class=&lt;fully specified Java class name&gt;"
   * parameter to create a {@code DataFlavor} with the desired
   ...
   * </pre>
   * Sun's implementation for Microsoft Windows uses the encoding {@code utf-16le}.
   * Sun's implementation for Solaris and Linux uses the encoding
   * {@code iso-10646-ucs-2}.
   *
   * @return a {@code DataFlavor} representing plain text
  ...
  /**
   * Selects the best text {@code DataFlavor} from an array of {@code
   * DataFlavor}s. Only {@code DataFlavor.stringFlavor}, and
   ...
   * "text/html", and {@code DataFlavor.stringFlavor} will be chosen
   * over {@code DataFlavor.plainTextFlavor}.
   * <p>
   ...
   * chosen {@code DataFlavor} which uses that MIME type. If so, the JRE
   ...
   * {@code DataFlavor}, developers must ensure that all
   * {@code DataFlavor}s with a "text/&lt;other&gt;" MIME type specify
   ...
   * {@code java.io.InputStream}, {@code java.nio.ByteBuffer},
   * {@code [B}, &lt;all others&gt;.
   * <p>
   ...
   * {@code java.nio.CharBuffer}, {@code [C}, &lt;all others&gt;.
   * <p>
   ...
   * specified above, or {@code null},
   * if {@code availableFlavors} is {@code null},
   ...
   * {@code java.io.Reader}, {@code java.lang.String},
   * {@code java.nio.CharBuffer}, {@code [C},
   * {@code java.io.InputStream}, {@code java.nio.ByteBuffer},
   * and {@code [B}.
   * <p>
   ...
   * decode it accordingly. See {@code selectBestTextFlavor} for a list
   ...
   * @return a {@code Reader} to read the {@code Transferable}'s
   * data
   * @throws IllegalArgumentException     if the representation class
   *                                      is not one of the seven listed above
   * @throws IllegalArgumentException     if the {@code Transferable}
   *                                      has {@code null} data
   ...
   *                                      is {@code java.io.InputStream},
   *                                      {@code java.nio.ByteBuffer}, or {@code [B} and
   *                                      this flavor's encoding is not supported by this
   *                                      implementation of the Java platform
   * @throws UnsupportedFlavorException   if the {@code Transferable}
   ...
   * {@code DataFlavor} will return when this {@code DataFlavor}
   * is requested.
   *
   ...
   * {@code DataFlavor} represents.  This name would be localized
  ...
  /**
   * Returns the human presentable name for this {@code DataFlavor}
   * if {@code paramName} equals "humanPresentableName".  Otherwise
   * returns the MIME type value associated with {@code paramName}.
   *
   * @param paramName the parameter name requested
   * @return the value of the name parameter, or {@code null}
   ...
   * as a parameter.
   *
   * @param that the {@code DataFlavor} to compare with
   *             {@code this}
  ...
  /**
   * Compares only the {@code mimeType} against the passed in
   * {@code String} and {@code representationClass} is
   * not considered in the comparison.
   * <p>
   * If {@code representationClass} needs to be compared, then
   ...
   * {@code s} is {@code null}
   * @deprecated As inconsistent with {@code hashCode()} contract,
   * use {@code isMimeTypeEqual(String)} instead.
   */
  @Deprecated
  ...
  /**
   * Returns hash code for this {@code DataFlavor}.
   * For two equal {@code DataFlavor}s, hash codes are equal.
   * For the {@code String}
   * that matches {@code DataFlavor.equals(String)}, it is not
   * guaranteed that {@code DataFlavor}'s hash code is equal
   * to the hash code of the {@code String}.
   *
   ...
   * as follows: Two {@code DataFlavor}s are considered equal if and
   ...
   * representation class is not {@code java.io.Reader},
   * {@code java.lang.String}, {@code java.nio.CharBuffer}, or
   * {@code [C}, the {@code charset} parameter must also be equal.
   * If a charset is not explicitly specified for one or both
   * {@code DataFlavor}s, the platform default encoding is assumed. See
   * {@code selectBestTextFlavor} for a list of text flavors which
  ...
  /**
   * String representation of this {@code DataFlavor} and its
   * parameters. The resulting {@code String} contains the name of
   * the {@code DataFlavor} class, this flavor's MIME type, and its
   ...
   * flavor's charset is also included. See {@code selectBestTextFlavor}
   ...
   * is equivalent to the MIME type of this {@code DataFlavor}.
   ...
   * equivalent to the MIME type of this {@code DataFlavor};
   * false otherwise
  ...
  /**
   * Compares the {@code mimeType} of two {@code DataFlavor}
   * objects. No parameters are considered.
   *
   * @param dataFlavor the {@code DataFlavor} to be compared
   * @return true if the {@code MimeType}s are equal,
   * otherwise false
   */
  ...
  /**
   * Does the {@code DataFlavor} represent a
  ...
  /**
   * Returns whether the representation class for this
   * {@code DataFlavor} is {@code java.nio.CharBuffer} or a
   * subclass thereof.
   *
   * @since 1.4
   */
  ...
  /**
   * Returns whether the representation class for this
   * {@code DataFlavor} is {@code java.nio.ByteBuffer} or a
   * subclass thereof.
   *
   * @since 1.4
   */
  ...
  /**
   * Returns true if the {@code DataFlavor} specified represents
   * a serialized object.
   *
   * @return true if the {@code DataFlavor} specified represents
   * a Serialized Object
   */
  ...
  /**
   * Returns whether this {@code DataFlavor} is a valid text flavor for
   * this implementation of the Java platform. Only flavors equivalent to
   * {@code DataFlavor.stringFlavor} and {@code DataFlavor}s with
   ...
   * {@code [B}. If the representation is
   * {@code java.io.InputStream}, {@code java.nio.ByteBuffer}, or
   * {@code [B}, then this flavor's {@code charset} parameter must
   ...
   * representation must be {@code java.io.InputStream},
   * {@code java.nio.ByteBuffer}, or {@code [B}.
   * <p>
   * See {@code selectBestTextFlavor} for a list of text flavors which
   * support the charset parameter.
   *
   * @return {@code true} if this {@code DataFlavor} is a valid
   * text flavor as described above; {@code false} otherwise
   * @see #selectBestTextFlavor
   * @since 1.4
   */
  ...
  /**
   * Called on {@code DataFlavor} for every MIME Type parameter
   * to allow {@code DataFlavor} subclasses to handle special
   * parameters like the text/plain {@code charset}
  ...
  /**
   * Called for each MIME type string to give {@code DataFlavor} subtypes
  ...
  static class TextFlavorComparator extends DataFlavorComparator {
    ...
    /**
     * Compares two {@code DataFlavor} objects. Returns a negative
     * integer, zero, or a positive integer as the first
     * {@code DataFlavor} is worse than, equal to, or better than the
     * second.
     * <p>
     * {@code DataFlavor}s are ordered according to the rules outlined
     * for {@code selectBestTextFlavor}.
     *
