...
public class Robot {
   ...
   *                mouse button masks.
   *                <p>
   *                It is allowed to use only a combination of valid values as a {@code
   *                buttons} parameter.
   ...
   *                and masks for existing extended mouse buttons, if the mouse has more then
   *                three buttons.
   ...
   * @throws IllegalArgumentException if the {@code buttons} mask contains the mask for extra
   *                                  mouse button
   *                                  that does not exist on the mouse and support for extended
   *                                  mouse buttons is
