...
public abstract class InputEvent extends ComponentEvent {
   ...
   *               are admissible (4, 5, etc.). There is no assigned constants for these
   *               extended buttons.
   *               The button masks for the extra buttons returned by this method have no
   *               assigned names like the
   ...
   *               of buttons that may hypothetically exist on the mouse but it is greater than
   *               the
   *               {@link java.awt.MouseInfo#getNumberOfButtons() MouseInfo.getNumberOfButtons()}.
   *               <p>
   * @throws IllegalArgumentException if {@code button} is less than zero or greater than the
   *                                  number
