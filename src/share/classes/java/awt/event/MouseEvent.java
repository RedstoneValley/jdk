...
public class MouseEvent extends InputEvent {
   ...
   * <li> 5
   * </ul>
   * If support for extended mouse buttons is {@link Toolkit#areExtraMouseButtonsEnabled()}
   * disabled by Java
   ...
   *                     then it is allowed to create {@code MouseEvent} objects only with the
   *                     standard buttons:
   ...
   *                     in addition to the standard buttons, {@code MouseEvent} objects can be
   *                     created
   ...
   * </pre>
   * In particular, for a mouse with one, two, or three buttons this method may return the
   * following values:
   * <ul>
   * <li> 0 ({@code NOBUTTON})
   * <li> 1 ({@code BUTTON1})
   ...
   * <li> 3 ({@code BUTTON3})
   * </ul>
   * Button numbers greater then {@code BUTTON3} have no constant identifier. So if a mouse
   * with five buttons is
   ...
   * buttons. So it is not expected that this method returns anything except {@code NOBUTTON},
   * {@code BUTTON1},
