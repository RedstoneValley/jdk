 ...
 * alt="Diagram shows virtual device containing 4 physical screens. Primary physical screen shows
 * coords (0,0), other screen shows (-80,-100)."
...
public class Window extends Container {
   ...
   *                                        background color is less than {@code 1.0f} and the
   *                                        window is decorated
   * @throws IllegalComponentStateException if the alpha value of the given
   *                                        background color is less than {@code 1.0f} and the
   *                                        window is in
 ...
 */
   ...
   * @throws IllegalComponentStateException if the window
   *                                        is showing on screen and locationByPlatform is {@code
   *                                        true}.
   * @see #setLocation
   * @see #isShowing
   * @see #setVisible
   ...
   *                                        TRANSLUCENT}
   *                                        translucency is not supported and the opacity is
   *                                        less than
   *                                        {@code 1.0f}
