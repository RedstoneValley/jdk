    ...
    protected ClipData export(Transferable transferable) {
        ...
        for (DataFlavor flavor : transferable.getTransferDataFlavors()) {
            ...
            if (contentsWithFlavor instanceof Intent) {
                return ClipData.newIntent(contentsWithFlavor.toString(),
                        (Intent) contentsWithFlavor);
                ...
                if (htmlFallback == null
                        && flavor.getMimeType().equals(ClipDescription.MIMETYPE_TEXT_HTML)) {
                    htmlFallback = contentsChars.toString();
                } else if (plainTextFallback1 == null
                        && flavor.getMimeType().equals(ClipDescription.MIMETYPE_TEXT_PLAIN)) {
        ...
        if (htmlFallback != null) {
            return ClipData.newHtmlText(
                    chosenPlainTextFallback, chosenPlainTextFallback, htmlFallback);
        } else {
