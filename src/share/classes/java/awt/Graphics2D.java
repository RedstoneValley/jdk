 ...
 * captured, the {@code Graphics2D} {@code Transform} is set up
...
public abstract class Graphics2D extends Graphics {
   ...
   * {@code Graphics2D} {@code Transform}
   ...
   * {@code Graphics2D} context.
   *
   * @return the current {@code Graphics2D} {@code Paint},
   ...
   * with a {@code null} {@code Paint} object does
   ...
   * {@code Graphics2D} context.
   *
   * @return the current {@code Graphics2D} {@code Composite},
   ...
   *
   * @return the current {@code Graphics2D} {@code Color},
   ...
   * {@code Graphics2D} context.
   *
   * @return the current {@code Graphics2D} {@code Stroke},
