...
public class Raster {
   ...
   *                                        in bounds, or if outData is too small to hold the
   *                                        output.
   ...
   * rectangle of pixels.
   * @throws ArrayIndexOutOfBoundsException if the coordinates or
   *                                        the band index are not in bounds, or if iArray is
   *                                        too small to
   *                                        hold the output.
   */
   ...
   * rectangle of pixels.
   * @throws ArrayIndexOutOfBoundsException if the coordinates or
   *                                        the band index are not in bounds, or if fArray is too
   *                                        small to
   *                                        hold the output.
   */
   ...
   * rectangle of pixels.
   * @throws ArrayIndexOutOfBoundsException if the coordinates or
   *                                        the band index are not in bounds, or if dArray is too
   *                                        small to
   *                                        hold the output.
   */
