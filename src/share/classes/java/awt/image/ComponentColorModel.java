 ...
 * obtained from the {@code ColorSpace's} {@code getMinValue}
...
public class ComponentColorModel extends ColorModel {
   ...
   * {@code CHANNEL_MAX}, {@code BITMASK} or {@code TRANSLUCENT}.
   ...
   *                                        {@code DataBuffer.TYPE_BYTE}, {@code DataBuffer
   *                                        .TYPE_USHORT},
   *                                        {@code DataBuffer.TYPE_INT}, {@code DataBuffer
   *                                        .TYPE_SHORT},
   *                                        {@code DataBuffer.TYPE_FLOAT}, or
   *                                        {@code DataBuffer.TYPE_DOUBLE}.
   */
   ...
   *                                        {@code ColorModel} does not support the
   *                                        unnormalized form
   * @throws ArrayIndexOutOfBoundsException If the {@code components}
   *                                        array is not null and is not large enough to hold
   *                                        all the color and
   ...
   * @throws IllegalArgumentException      If this
   *                                       {@code ComponentColorModel} does not support the
   *                                       unnormalized form
   ...
   *                                       not null and is not large enough to hold all the color
   *                                       and alpha
   *                                       components (starting at offset), or if
   *                                       {@code pixel} is not large
   ...
   *                                        is not large enough to hold all the color and alpha
   *                                        components
   *                                        (starting at offset).
   ...
   *                                        the {@code normComponents} array is not large
   *                                        enough to
   ...
   * @throws ArrayIndexOutOfBoundsException if
   *                                        {@code normComponents} is not large enough to
   *                                        hold all
