...
public class MultiResolutionCachedImage extends AbstractMultiResolutionImage {
  ...
  public MultiResolutionCachedImage(
      int baseImageWidth, int baseImageHeight, BiFunction<Integer, Integer, Image> mapper) {
    this(baseImageWidth,
        baseImageHeight,
  ...
  public MultiResolutionCachedImage(
      int baseImageWidth, int baseImageHeight, Dimension2D[] sizes,
  ...
  public MultiResolutionCachedImage map(Function<Image, Image> mapper) {
    return new MultiResolutionCachedImage(baseImageWidth,
        baseImageHeight,
        sizes,
        (width, height) -> mapper.apply(getResolutionVariant(width, height)));
  }
