...
public class WritableRasterNative extends WritableRaster {
  ...
  public static WritableRasterNative createNativeRaster(
      ColorModel cm, SurfaceData sd, int width, int height) {
    SampleModel smHw;
    int dataType;
    ...
    switch (cm.getPixelSize()) {
      ...
      case 12:
        ...
        dataType = cm.getPixelSize() == 8 ? DataBuffer.TYPE_BYTE : DataBuffer.TYPE_USHORT;
        int[] bandOffsets = new int[1];
        bandOffsets[0] = 0;
        smHw = new PixelInterleavedSampleModel(dataType, width, height, 1, width, bandOffsets);
        break;
      ...
      case 16:
        ...
        smHw = new SinglePixelPackedSampleModel(dataType, width, height, width, bitMasks);
        break;
      case 24:
      case 32:
