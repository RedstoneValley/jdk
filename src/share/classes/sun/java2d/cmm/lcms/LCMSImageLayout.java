...
class LCMSImageLayout {
  ...
  public static final int PT_BGRA_8 = EXTRA_SH(1) | CHANNELS_SH(3) | BYTES_SH(1) | DOSWAP
      | SWAPFIRST;
  ...
  private LCMSImageLayout(
      int width, int height, int pixelType, int pixelSize) throws ImageLayoutException {
    this.pixelType = pixelType;
    this.width = width;
    this.height = height;
    nextPixelOffset = pixelSize;
