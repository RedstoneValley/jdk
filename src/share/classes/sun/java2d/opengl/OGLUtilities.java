...
class OGLUtilities {
   ...
   */
  public static boolean invokeWithOGLSharedContextCurrent(
      GraphicsConfiguration config, Runnable r) {
   ...
   */
  public static Rectangle getOGLViewport(
      Graphics g, int componentWidth, int componentHeight) {
    if (!(g instanceof SunGraphics2D)) {
      return null;
    }
