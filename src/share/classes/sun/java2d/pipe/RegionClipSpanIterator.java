...
public class RegionClipSpanIterator implements SpanIterator {
  ...
  Region rgn;
  final SpanIterator spanIter;

  // The cursors that track the progress through the region
  final RegionIterator resetState;
  final RegionIterator lwm;
  RegionIterator row;
  RegionIterator box;
  ...
  public boolean nextSpan(int[] resultbox) {
    ...
    while (true) {
      ...
      resultlox = spanlox > rgnlox ? spanlox : rgnlox;

      resultloy = spanloy > rgnloy ? spanloy : rgnloy;

      resulthix = spanhix < rgnhix ? spanhix : rgnhix;

      resulthiy = spanhiy < rgnhiy ? spanhiy : rgnhiy;
