...
public class DrawImage implements DrawImagePipe {
  ...
  protected boolean renderImageScale(
      SunGraphics2D sg, Image img, Color bgColor, int interpType, int sx1, int sy1, int sx2,
          ...
          if (raster instanceof sun.awt.image.BytePackedRaster) {
            ...
            if (matrix[1] == 0. && matrix[2] == 0. && matrix[4] == 0. && matrix[5] == 0.) {
              ...
              if (mapSize < 256) {
                ...
                icm.getRGBs(cmap);
                cmap[mapSize] = 0x0000;
                dstCM = new IndexColorModel(icm.getPixelSize(),
                    mapSize + 1,
                    cmap,
                    0,
                    true,
  ...
  protected void blitSurfaceData(
      SunGraphics2D sg, Region clipRegion, SurfaceData srcData, SurfaceData dstData,
      SurfaceType srcType, SurfaceType dstType, int sx, int sy, int dx, int dy, int w, int h,
      Color bgColor) {
    if (w <= 0 || h <= 0) {
            /*
