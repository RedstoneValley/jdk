...
public final class BufferedPaints {
   ...
   */
  private static void setGradientPaint(
  ...
  private static void setGradientPaint(
      RenderQueue rq, SunGraphics2D sg2d, GradientPaint paint, boolean useMask) {
    setGradientPaint(rq,
        (AffineTransform) sg2d.transform.clone(),
        paint.getColor1(),
        paint.getColor2(),
        paint.getPoint1(),
        paint.getPoint2(),
   ...
   * we were seeking.
   */
  private static void setTexturePaint(
      RenderQueue rq, SunGraphics2D sg2d, TexturePaint paint, boolean useMask) {
