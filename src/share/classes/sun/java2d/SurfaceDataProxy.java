...
public abstract class SurfaceDataProxy implements DisplayChangedListener, FlushableCacheData {
  ...
  public static final SurfaceDataProxy UNCACHED = new SurfaceDataProxy(0) {
    ...
    @Override
    public SurfaceData replaceData(
        SurfaceData srcData, int txtype, CompositeType comp, Color bgColor) {
   ...
   */
  public abstract boolean isSupportedOperation(
      SurfaceData srcData, int txtype, CompositeType comp, Color bgColor);
   ...
   * revalidation.
   */
  public abstract SurfaceData validateSurfaceData(
      SurfaceData srcData, SurfaceData cachedData, int w, int h);
   ...
   */
  public void updateSurfaceDataBg(
      SurfaceData srcData, SurfaceData dstData, int w, int h, Color bgColor) {
    SurfaceType srcType = srcData.getSurfaceType();
    SurfaceType dstType = dstData.getSurfaceType();
