...
public final class CustomComponent {
  public static void register() {
    ...
    GraphicsPrimitive[] primitives = {
        new GraphicsPrimitiveProxy(
            ...
            SurfaceType.IntArgb), new GraphicsPrimitiveProxy(
        owner,
        "OpaqueCopyArgbToAny",
        Blit.methodSignature,
        Blit.primTypeID,
        SurfaceType.IntArgb,
        CompositeType.SrcNoEa,
        SurfaceType.Any), new GraphicsPrimitiveProxy(
        owner,
        "XorCopyArgbToAny",
        Blit.methodSignature,
        Blit.primTypeID,
  ...
  public static Region getRegionOfInterest(
      SurfaceData src, SurfaceData dst, Region clip, int srcx, int srcy, int dstx, int dsty, int w,
      int h) {
        /*
         * Intersect all of:
