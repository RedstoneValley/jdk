...
public interface MyCursor {
    Cursor NO_DROP = Toolkit.getDefaultToolkit().createCustomCursor(
    ...
    Cursor MOVE = Toolkit.getDefaultToolkit().createCustomCursor(
        new ImageGenerator(32, 32, new Color(0xff, 0xff, 0xff, 0x00) ) {
                @Override public void paint(Graphics gr) {
                    gr.setColor(Color.GREEN);
                    ((Graphics2D)gr).setStroke(new BasicStroke(3));
    ...
    Cursor COPY = Toolkit.getDefaultToolkit().createCustomCursor(
        new ImageGenerator(32, 32, new Color(0xff, 0xff, 0xff, 0x00) ) {
                @Override public void paint(Graphics gr) {
                    gr.setColor(Color.GREEN);
                    ((Graphics2D)gr).setStroke(new BasicStroke(3));
                    ...
                    gr.drawLine(
                        width *3/4 - 1, height /2 - 1, width *3/4 - 1,
                        height);
