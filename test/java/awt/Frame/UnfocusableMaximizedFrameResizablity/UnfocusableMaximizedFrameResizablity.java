...
public final class UnfocusableMaximizedFrameResizablity
{
    private UnfocusableMaximizedFrameResizablity() {
    }
    ...
    private static void init()
    {
        ...
        Frame f = new Frame("Unfocusable frame");
        ...
        Rectangle finalBounds = f.getBounds();
