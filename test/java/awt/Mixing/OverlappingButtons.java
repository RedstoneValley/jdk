...
public final class OverlappingButtons
{

    //*** test-writer defined static variables go here ***

    static volatile String testSeq = "";
    static final String checkSeq = "010101";

    private OverlappingButtons() {
    }
    ...
    private static void init()
    {
        ...
        // Create components
        Frame f = new Frame("Button-JButton mix test");
        Panel p = new Panel();
        ...
        if (testSeq.equals(checkSeq)) {
            ...
            fail("The components changed their visible Z-order in a wrong sequence: '" + testSeq + "' instead of '" + checkSeq + "'");
        }
    }//End  init()
