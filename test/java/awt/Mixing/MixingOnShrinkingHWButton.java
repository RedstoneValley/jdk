...
public final class MixingOnShrinkingHWButton
{
    static volatile boolean heavyClicked;
    static volatile boolean lightClicked;

    private MixingOnShrinkingHWButton() {
    }
    ...
    private static void init()
    {
        ...
        // Create components
        Dialog d = new Dialog((Frame)null, "Button-JButton mix test");
        Button heavy = new Button("  Heavyweight Button  ");
        JButton light = new JButton("  LW Button  ");
        ...
        if (lightClicked) {
            ...
            fail("The lightweight component left behind the heavyweight one.");
        }
    }//End  init()
