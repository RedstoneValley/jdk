...
public class AcceptExtraButton extends Frame {
    static final int [] eventID = {MouseEvent.MOUSE_PRESSED, MouseEvent.MOUSE_RELEASED, MouseEvent.MOUSE_CLICKED};


  private static final long serialVersionUID = -1451312667271608329L;
  ...
  public static void main(String []s){
      ...
      for (int anEventID : eventID) {
        for (int button = 0; button <= MouseInfo.getNumberOfButtons(); button++) {
          System.out.println("button == " + button);
          MouseEvent me = new MouseEvent(f, anEventID, System.currentTimeMillis(), 0,
