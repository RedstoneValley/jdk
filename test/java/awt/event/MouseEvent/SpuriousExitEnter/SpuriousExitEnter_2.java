...
/*
  ...
  There is a JFrame with a JButton in it (Lightweight) and a Frame with a Button in it
  (Heavyweight).
...
public final class SpuriousExitEnter_2 {
    static final JFrame frame = new JFrame("SpuriousExitEnter_2(LW)");
    static final JButton jbutton = new JButton("jbutton");

    static final Frame frame1 = new Frame("SpuriousExitEnter_2 (HW)");
    static final Button button1 = new Button(Button.base);

    private SpuriousExitEnter_2() {
    }
