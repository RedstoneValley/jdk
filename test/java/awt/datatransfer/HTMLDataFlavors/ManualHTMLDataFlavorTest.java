...
public class ManualHTMLDataFlavorTest extends Applet {
    ...
    class DropPane extends Panel implements DropTargetListener {
        ...
        private static final long serialVersionUID = -332570572069222100L;
        ...
        public void drop(DropTargetDropEvent dtde) {
            ...
            if (!dtde.isDataFlavorSupported(DataFlavor.fragmentHtmlFlavor)) {
                Sysout.println("DataFlavor.fragmentHtmlFlavor is not present in the system clipboard");
                dtde.rejectDrop();
                return;
            }
            if (!dtde.isDataFlavorSupported(DataFlavor.selectionHtmlFlavor)) {
