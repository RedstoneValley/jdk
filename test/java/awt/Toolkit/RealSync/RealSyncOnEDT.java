...
public final class RealSyncOnEDT
{
    static Exception exceptionCaught;

    private RealSyncOnEDT() {
    }
    ...
    private static void init()
    {
        ...
        if (!"sun.awt.SunToolkit$IllegalThreadException".equals(exceptionCaught
            .getClass()
            .getName())) {
