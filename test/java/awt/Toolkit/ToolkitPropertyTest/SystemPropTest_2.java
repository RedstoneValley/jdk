...
public final class SystemPropTest_2 {

  private SystemPropTest_2() {
  }
  ...
  public static void main(String []s){
        ...
        if (!propValue){
            throw new RuntimeException("TEST FAILED : System property sun.awt.enableExtraMouseButtons = " + false);
        }
