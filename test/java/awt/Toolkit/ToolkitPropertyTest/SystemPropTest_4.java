...
public final class SystemPropTest_4 {
  private SystemPropTest_4() {
  }
  ...
  public static void main(String []s){
        ...
        if (!propValue){
            throw new RuntimeException("TEST FAILED(1) : System property sun.awt.enableExtraMouseButtons = " + false);
        }
        ...
        if (propValue){
            throw new RuntimeException("TEST FAILED(2) : System property sun.awt.enableExtraMouseButtons = " + true);
        }
        if (!Toolkit.getDefaultToolkit().areExtraMouseButtonsEnabled()){
