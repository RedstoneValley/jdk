...
public final class Geometry {
  ...
  public static Matrix transformToMatrix(AffineTransform transform) {
    ...
    matrix.setValues(new float[]{
        (float) transform.getScaleX(), (float) transform.getShearX(),
        (float) transform.getTranslateX(),
        (float) transform.getShearY(), (float) transform.getScaleY(),
  ...
  public static Shape translate(Shape orig, int offsetX, int offsetY) {
    return new Shape.Translated(orig, offsetX, offsetY);
  }
