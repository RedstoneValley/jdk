...
import skinjob.util.EmptyAttributeSet;
...
public class SkinJobWindowPeer<T extends Window> extends SkinJobComponentPeer<T>
  ...
  private static final AttributeSet MENU_BAR_ATTRIBUTES = EmptyAttributeSet.INSTANCE; // TODO
  ...
  @Override
  public void blockWindows(List<java.awt.Window> windows) {
    // TODO
  }
