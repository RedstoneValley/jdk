...
public class ShellFolder extends File {
  ...
  /**
   * Invokes the {@code task} which doesn't throw checked exceptions from its {@code call} method.
   * If invokation is interrupted then Thread.currentThread() .isInterrupted() will be set and
  ...
  /**
   * Invokes the {@code task} which throws checked exceptions from its {@code call} method. If
   * invokation is interrupted then Thread.currentThread().isInterrupted() will be set and
   * InterruptedException will be thrown as well.
   */
  ...
  /**
   * This method is implemented to make sure that no instances of {@code ShellFolder} are ever
   * serialized. An instance of this default implementation can always be represented with a {@code
  ...
  /**
   * Returns the path for this object's parent, or {@code null} if this object does not name a
   * parent folder.
   *
   * @return the path as a String for this object's parent, or {@code null} if this object does not
  ...
  /**
   * Returns a File object representing this object's parent, or {@code null} if this object does
   * not name a parent folder.
   *
   * @return a File object representing this object's parent, or {@code null} if this object does
   * not name a parent folder
   * @since 1.4
   */
  @Override
