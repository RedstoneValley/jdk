...
/**
 * Linked list implementation of the <tt>List</tt> interface.  Implements all optional list
 * operations, and permits all elements (including <tt>null</tt>).  In addition to implementing the
 * <tt>List</tt> interface, the <tt>IdentityLinkedList</tt> class provides uniformly named methods
 * to <tt>get</tt>, <tt>remove</tt> and <tt>insert</tt> an element at the beginning and end of the
 * list.  These operations allow linked lists to be used as a stack, {@linkplain Queue queue}, or
 * {@linkplain Deque double-ended queue}. <p>
 * <p>
 * The class implements the <tt>Deque</tt> interface, providing first-in-first-out queue operations
 * for <tt>add</tt>, <tt>poll</tt>, along with other stack and deque operations.<p>
 * <p>
 ...
 * a linked list concurrently, and at least one of the threads modifies the list structurally, it
 * <i>must</i> be synchronized externally.  (A structural modification is any operation that adds or
 * deletes one or more elements; merely setting the value of an element is not a structural
...
public class IdentityLinkedList<E> extends AbstractSequentialList<E> implements Deque<E> {
  ...
  /**
   * Retrieves and removes the first element of this list, or returns <tt>null</tt> if this list is
   * empty.
   *
   * @return the first element of this list, or <tt>null</tt> if this list is empty
   * @since 1.6
   */
  @Override
  public E pollFirst() {
  ...
  /**
   * Retrieves and removes the last element of this list, or returns <tt>null</tt> if this list is
   * empty.
   *
   * @return the last element of this list, or <tt>null</tt> if this list is empty
   * @since 1.6
   */
  @Override
  public E pollLast() {
  ...
  /**
   * Retrieves, but does not remove, the first element of this list, or returns <tt>null</tt> if
   * this list is empty.
   *
   * @return the first element of this list, or <tt>null</tt> if this list is empty
   * @since 1.6
  ...
  /**
   * Retrieves, but does not remove, the last element of this list, or returns <tt>null</tt> if this
   * list is empty.
   *
   * @return the last element of this list, or <tt>null</tt> if this list is empty
   * @since 1.6
   ...
   * with the lowest index <tt>i</tt> such that <tt>get(i)==o</tt> (if such an element exists).
   * Returns <tt>true</tt> if this list contained the specified element (or equivalently, if this
   ...
   * <tt>get(i)==o</tt>, or -1 if there is no such index.
   *
   ...
   * that <tt>get(i)==o</tt>, or -1 if there is no such index.
   *
   * @param o element to search for
   ...
   * <tt>add</tt> methods, the list-iterator will throw a <tt>ConcurrentModificationException</tt>.
