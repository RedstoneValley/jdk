...
/**
 * Provides complete information to make and handle the selection of an input method and a locale.
 * Immutable class.
 */
final class InputMethodLocator {
  ...
  public boolean equals(Object other) {
    ...
    return !(loader == null && otherLocator.loader != null || loader != null && !loader.equals(
        otherLocator.loader)) && !(locale == null && otherLocator.locale != null
  ...
  /**
   * Returns an input method locator that has locale forLocale, but otherwise the same data as this
   * locator. Does not check whether the input method actually supports forLocale - use {@link
   * #isLocaleAvailable} for that.
   */
  ...
  /**
   * Returns whether this and other describe the same input method engine, ignoring the locale
   * setting.
   */
  boolean sameInputMethod(InputMethodLocator other) {
    ...
    return descriptor.getClass().equals(other.descriptor.getClass()) && !(
        loader == null && other.loader != null || loader != null && !loader.equals(other.loader));
  }

  /**
   * Returns a string that can be used as an action command string. The first part of the string
   * identifies the input method; it does not include '\n'. If getLocale is not null,
   * getLocale().toString() is appended, separated by '\n'.
   */
