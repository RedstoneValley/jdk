...
public abstract class Curve {
   ...
   * <p>
   * During processing of the path it actually counts every time the path crosses either or both of
   * the top and bottom edges of that shadow.  If the path enters from the top, the count is
   ...
   * <p>
   * Thus, the winding count that it accumulates is actually double the real winding count.  Since
  ...
  public static void insertMove(List curves, double x, double y) {
    curves.add(new Order0(x, y));
  }

  public static void insertLine(List curves, double x0, double y0, double x1, double y1) {
    if (y0 < y1) {
   ...
   */
  public static int pointCrossingsForLine(
  ...
  public static int pointCrossingsForQuad(
      double px, double py, double x0, double y0, double xc, double yc, double x1, double y1,
      int level) {
  ...
  public static int pointCrossingsForCubic(
      double px, double py, double x0, double y0, double xc0, double yc0, double xc1, double yc1,
  ...
  public static int rectCrossingsForLine(
      int crossings, double rxmin, double rymin, double rxmax, double rymax, double x0, double y0,
      double x1, double y1) {
   ...
   * rectangle.  See the comment for the RECT_INTERSECTS constant for more complete details.
   */
  public static int rectCrossingsForQuad(
      int crossings, double rxmin, double rymin, double rxmax, double rymax, double x0, double y0,
   ...
   * rectangle.  See the comment for the RECT_INTERSECTS constant for more complete details.
   */
  public static int rectCrossingsForCubic(
      int crossings, double rxmin, double rymin, double rxmax, double rymax, double x0, double y0,
      double xc0, double yc0, double xc1, double yc1, double x1, double y1, int level) {
  ...
  public boolean findIntersect(
      Curve that, double[] yrange, double ymin, int slevel, int tlevel, double s0, double xs0,
      double ys0, double s1, double xs1, double ys1, double t0, double xt0, double yt0, double t1,
