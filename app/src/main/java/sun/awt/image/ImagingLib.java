...
/**
 * This class provides a hook to access platform-specific imaging code.
 * <p>
 * If the implementing class cannot handle the op, tile format or image format, the method will
 * return null; If there is an error when processing the data, the implementing class may either
 * return null (in which case our java code will be executed) or may throw an exception.
 */
