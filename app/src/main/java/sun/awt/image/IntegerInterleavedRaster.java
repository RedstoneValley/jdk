...
public class IntegerInterleavedRaster extends IntegerComponentRaster {
  ...
  /**
   * Constructs a IntegerInterleavedRaster with the given SampleModel. The Raster's upper left
   * corner is origin and it is the same size as the SampleModel.  A DataBuffer large enough to
   * describe the Raster is automatically created.  SampleModel must be of type
  ...
  /**
   * Constructs a IntegerInterleavedRaster with the given SampleModel and DataBuffer.  The Raster's
   * upper left corner is origin and it is the same sizes the SampleModel.  The DataBuffer is not
   * initialized and must be a DataBufferInt compatible with SampleModel. SampleModel must be of
