...
public class ToolkitImage extends Image {
  ...
  /**
   * The object which is used to reconstruct the original image data as needed.
   */
  ...
  /**
   * Return the width of the original image source. If the width isn't known, then the image is
   * reconstructed.
   */
  public int getWidth() {
    if (src != null) {
  ...
  /**
   * Return the width of the original image source. If the width isn't known, then the ImageObserver
   * object will be notified when the data is available.
   */
  @Override
  ...
  /**
   * Return the height of the original image source. If the height isn't known, then the
   * ImageObserver object will be notified when the data is available.
   */
  @Override
  ...
  /**
   * Return a property of the image by name.  Individual property names are defined by the various
   * image formats.  If a property is not defined for a particular image, then this method will
   * return the UndefinedProperty object.  If the properties for this image are not yet known, then
   * this method will return null and the ImageObserver object will be notified later.  The property
   * name "comment" should be used to store an optional comment which can be presented to the user
   * as a description of the image, its source, or its author.
   */
  @Override
  ...
  /**
   * Return the height of the original image source. If the height isn't known, then the image is
   * reconstructed.
   */
