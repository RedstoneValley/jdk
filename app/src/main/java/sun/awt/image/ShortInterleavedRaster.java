 ...
 * <p>
 * For example, 5-6-5 RGB image data can be represented by a ShortInterleavedRaster using a
...
public class ShortInterleavedRaster extends ShortComponentRaster {
   ...
   * the Raster is automatically created.  SampleModel must be of type PixelInterleavedSampleModel
  ...
  /**
   * Constructs a ShortInterleavedRaster with the given SampleModel and DataBuffer.  The Raster's
   ...
   * type PixelInterleavedSampleModel or SinglePixelPackedSampleModel.
   *
   * @param sampleModel The SampleModel that specifies the layout.
  ...
  /**
   * Constructs a ShortInterleavedRaster with the given SampleModel, DataBuffer, and parent.
   * DataBuffer must be a DataBufferUShort and SampleModel must be of type
   * PixelInterleavedSampleModel or SinglePixelPackedSampleModel.  When translated into the base
   * Raster's coordinate system, aRegion must be contained by the base Raster. Origin is the
   * coodinate in the new Raster's coordinate system of the origin of the base Raster.  (The base
   * Raster is the Raster's ancestor which has no parent.)
   * <p>
