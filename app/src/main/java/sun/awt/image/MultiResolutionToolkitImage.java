...
public class MultiResolutionToolkitImage extends ToolkitImage {
  ...
  public static ImageObserver getResolutionVariantObserver(
      final Image image, final ImageObserver observer, final boolean concatenateInfo) {
    ...
    synchronized (ObserverCache.INSTANCE) {
      ...
      if (o == null) {
        ...
        o = new ImageObserver() {
          @Override
          public boolean imageUpdate(Image resolutionVariant, int flags, int x, int y, int width,
              int height) {
