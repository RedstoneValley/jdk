...
public abstract class VSyncedBSManager {
  ...
  private static final boolean vSyncLimit = Boolean
      .valueOf(System.getProperty("sun.java2d.vsynclimit", "true"));
  ...
  /**
   * Lets the manager know that this buffer strategy is no longer interested in being v-synced.
   */
  ...
  /**
   * An instance of the manager which allows any buffer strategy to be v-synced.
   */
  ...
  /**
   * An instance of the manager which allows only one buffer strategy to be v-synced at any give
   * moment in the vm.
   */
