...
public class StandardGlyphVector extends GlyphVector {
  ...
  public boolean equals(Object o) {
    ...
    return getFont() != null
        ? getFont().equals(that.getFont())
        : that.getFont() == null && (getFontRenderContext() != null ? getFontRenderContext()
            .equals(that.getFontRenderContext()) : that.getFontRenderContext() == null);
  }
