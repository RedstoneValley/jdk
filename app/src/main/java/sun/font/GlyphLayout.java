...
public final class GlyphLayout {
  ...
  /**
   * Return the old instance of GlyphLayout when you are done.  This enables reuse of GlyphLayout
   * objects.
   */
  ...
  public static final class GVData {
    ...
    public StandardGlyphVector createGlyphVector(Font font, FontRenderContext frc,
      ...
      if (_flags == UNINITIALIZED_FLAGS) {
        ...
        if (_count > 1) { // if only 1 glyph assume LTR
          ...
          if (rtl) {
            _flags |= GlyphVector.FLAG_RUN_RTL;
          }
          if (!rtl && !ltr) {
            _flags |= GlyphVector.FLAG_COMPLEX_GLYPHS;
          }
        }
