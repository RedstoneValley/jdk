...
public class Cursor implements Serializable {
  ...
  /**
   * The chosen cursor type initially set to the {@code DEFAULT_CURSOR}.
   *
   * @serial
   * @see #getType()
   */
  ...
  /**
   * Creates a new custom cursor object with the specified name.<p> Note:  this constructor should
   * only be used by AWT implementations as part of their support for custom cursors.  Applications
   * should use Toolkit.createCustomCursor().
   *
