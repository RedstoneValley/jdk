...
/**
 * {@code AWTEventMulticaster} implements efficient and thread-safe multi-cast event dispatching for
 * the AWT events defined in the {@code java.awt.event} package.
 * <p>
 ...
 * }
 * }</pre>
 * The important point to note is the first argument to the {@code add} and {@code remove} methods
 * is the field maintaining the listeners. In addition you must assign the result of the {@code add}
 * and {@code remove} methods to the field maintaining the listeners.
 * <p>
 * {@code AWTEventMulticaster} is implemented as a pair of {@code EventListeners} that are set at
 * construction time. {@code AWTEventMulticaster} is immutable. The {@code add} and {@code remove}
 * methods do not alter {@code AWTEventMulticaster} in anyway. If necessary, a new {@code
 * AWTEventMulticaster} is created. In this way it is safe to add and remove listeners during the
 * process of an event dispatching.  However, event listeners added during the process of an event
 * dispatch operation are not notified of the event currently being dispatched.
 * <p>
 * All of the {@code add} methods allow {@code null} arguments. If the first argument is {@code
 * null}, the second argument is returned. If the first argument is not {@code null} and the second
 * argument is {@code null}, the first argument is returned. If both arguments are {@code non-null},
 * a new {@code AWTEventMulticaster} is created using the two arguments and returned.
 * <p>
 * For the {@code remove} methods that take two arguments, the following is returned: <ul>
 * <li>{@code null}, if the first argument is {@code null}, or the arguments are equal, by way of
 * {@code ==}. <li>the first argument, if the first argument is not an instance of {@code
 * AWTEventMulticaster}. <li>result of invoking {@code remove(EventListener)} on the first argument,
 * supplying the second argument to the {@code remove(EventListener)} method. </ul>
 *
 * @author John Rose
 * @author Amy Fowler
 * @since 1.1
...
public class AWTEventMulticaster
    ...
    MouseMotionListener, WindowListener, WindowFocusListener, WindowStateListener, ActionListener,
    ItemListener, AdjustmentListener, TextListener, InputMethodListener, HierarchyListener,
    HierarchyBoundsListener, MouseWheelListener {

  protected final EventListener a, b;

  /**
   * Creates an event multicaster instance which chains listener-a with listener-b. Input parameters
   * {@code a} and {@code b} should not be {@code null}, though implementations may vary in choosing
   * whether or not to throw {@code NullPointerException} in that case.
   *
   * @param a listener-a
   * @param b listener-b
   */
  ...
  /**
   * Adds component-listener-a with component-listener-b and returns the resulting multicast
   * listener.
   *
  ...
  /**
   * Adds container-listener-a with container-listener-b and returns the resulting multicast
   * listener.
   *
  ...
  /**
   * Adds mouse-motion-listener-a with mouse-motion-listener-b and returns the resulting multicast
   * listener.
   *
  ...
  /**
   * Adds window-state-listener-a with window-state-listener-b and returns the resulting multicast
   * listener.
   *
   ...
   * @since 1.4
   */
  public static WindowStateListener add(
      WindowStateListener a, WindowStateListener b) {
    return (WindowStateListener) addInternal(a, b);
  }

  /**
   * Adds window-focus-listener-a with window-focus-listener-b and returns the resulting multicast
   * listener.
   *
   ...
   * @since 1.4
   */
  public static WindowFocusListener add(
      WindowFocusListener a, WindowFocusListener b) {
  ...
  /**
   * Adds adjustment-listener-a with adjustment-listener-b and returns the resulting multicast
   * listener.
   *
  ...
  /**
   * Adds input-method-listener-a with input-method-listener-b and returns the resulting multicast
   * listener.
   *
  ...
  /**
   * Adds hierarchy-listener-a with hierarchy-listener-b and returns the resulting multicast
   * listener.
   *
  ...
  /**
   * Adds hierarchy-bounds-listener-a with hierarchy-bounds-listener-b and returns the resulting
   * multicast listener.
   *
   ...
   * @since 1.3
   */
  public static HierarchyBoundsListener add(
      HierarchyBoundsListener a, HierarchyBoundsListener b) {
    return (HierarchyBoundsListener) addInternal(a, b);
  }

  /**
   * Adds mouse-wheel-listener-a with mouse-wheel-listener-b and returns the resulting multicast
   * listener.
   *
  ...
  /**
   * Removes the old component-listener from component-listener-l and returns the resulting
   * multicast listener.
   *
  ...
  /**
   * Removes the old container-listener from container-listener-l and returns the resulting
   * multicast listener.
   *
  ...
  /**
   * Removes the old focus-listener from focus-listener-l and returns the resulting multicast
   * listener.
   *
  ...
  /**
   * Removes the old mouse-listener from mouse-listener-l and returns the resulting multicast
   * listener.
   *
  ...
  /**
   * Removes the old mouse-motion-listener from mouse-motion-listener-l and returns the resulting
   * multicast listener.
   *
  ...
  /**
   * Removes the old window-listener from window-listener-l and returns the resulting multicast
   * listener.
   *
  ...
  /**
   * Removes the old window-state-listener from window-state-listener-l and returns the resulting
   * multicast listener.
   *
   ...
   * @since 1.4
   */
  public static WindowStateListener remove(
      WindowStateListener l, WindowStateListener oldl) {
    return (WindowStateListener) removeInternal(l, oldl);
  }

  /**
   * Removes the old window-focus-listener from window-focus-listener-l and returns the resulting
   * multicast listener.
   *
   ...
   * @since 1.4
   */
  public static WindowFocusListener remove(
      WindowFocusListener l, WindowFocusListener oldl) {
    return (WindowFocusListener) removeInternal(l, oldl);
  }

  /**
   * Removes the old action-listener from action-listener-l and returns the resulting multicast
   * listener.
   *
  ...
  /**
   * Removes the old item-listener from item-listener-l and returns the resulting multicast
   * listener.
   *
  ...
  /**
   * Removes the old adjustment-listener from adjustment-listener-l and returns the resulting
   * multicast listener.
   *
  ...
  /**
   * Removes the old input-method-listener from input-method-listener-l and returns the resulting
   * multicast listener.
   *
  ...
  /**
   * Removes the old hierarchy-listener from hierarchy-listener-l and returns the resulting
   * multicast listener.
   *
  ...
  /**
   * Removes the old hierarchy-bounds-listener from hierarchy-bounds-listener-l and returns the
   ...
   * @since 1.3
   */
  public static HierarchyBoundsListener remove(
      HierarchyBoundsListener l, HierarchyBoundsListener oldl) {
    return (HierarchyBoundsListener) removeInternal(l, oldl);
  }

  /**
   * Removes the old mouse-wheel-listener from mouse-wheel-listener-l and returns the resulting
   * multicast listener.
   *
   ...
   * @since 1.4
   */
  public static MouseWheelListener remove(
      MouseWheelListener l, MouseWheelListener oldl) {
    return (MouseWheelListener) removeInternal(l, oldl);
  }

  /**
   * Returns the resulting multicast listener from adding listener-a and listener-b together. If
   * listener-a is null, it returns listener-b; If listener-b is null, it returns listener-a If
   * neither are null, then it creates and returns a new AWTEventMulticaster instance which chains a
   * with b.
   *
  ...
  /**
   * Returns the resulting multicast listener after removing the old listener from listener-l. If
   * listener-l equals the old listener OR listener-l is null, returns null. Else if listener-l is
   * an instance of AWTEventMulticaster, then it removes the old listener from it. Else, returns
   * listener l.
   *
  ...
  /**
   * Returns an array of all the objects chained as <code><em>Foo</em>Listener</code>s by the
   * specified {@code java.util.EventListener}. <code><em>Foo</em>Listener</code>s are chained by
   * the {@code AWTEventMulticaster} using the <code>add<em>Foo</em>Listener</code> method. If a
   * {@code null} listener is specified, this method returns an empty array. If the specified
   * listener is not an instance of {@code AWTEventMulticaster}, this method returns an array which
   * contains only the specified listener. If no such listeners are chained, this method returns an
   * empty array.
   *
   ...
   * <p>
   * The returned multicaster contains all the listeners in this multicaster with the exception of
   * all occurrences of {@code oldl}. If the resulting multicaster contains only one regular
   * listener the regular listener may be returned.  If the resulting multicaster is empty, then
   * {@code null} may be returned instead.
   * <p>
  ...
  /**
   * Handles the componentResized event by invoking the componentResized methods on listener-a and
   * listener-b.
   *
  ...
  /**
   * Handles the componentMoved event by invoking the componentMoved methods on listener-a and
   * listener-b.
   *
   * @param e the component event
   */
  ...
  /**
   * Handles the componentHidden event by invoking the componentHidden methods on listener-a and
   * listener-b.
   *
   * @param e the component event
   */
  ...
  /**
   * Handles the componentAdded container event by invoking the componentAdded methods on listener-a
   * and listener-b.
   *
   * @param e the component event
   */
  ...
  /**
   * Handles the focusGained event by invoking the focusGained methods on listener-a and
   * listener-b.
   *
  ...
  /**
   * Handles the keyReleased event by invoking the keyReleased methods on listener-a and
   * listener-b.
   *
   * @param e the key event
   */
  ...
  /**
   * Handles the mouseEntered event by invoking the mouseEntered methods on listener-a and
   * listener-b.
   *
   * @param e the mouse event
   */
  ...
  /**
   * Handles the mouseExited event by invoking the mouseExited methods on listener-a and
   * listener-b.
   *
   * @param e the mouse event
   */
  ...
  /**
   * Handles the mouseDragged event by invoking the mouseDragged methods on listener-a and
   * listener-b.
   *
   * @param e the mouse event
   */
  ...
  /**
   * Handles the windowOpened event by invoking the windowOpened methods on listener-a and
   * listener-b.
   *
  ...
  /**
   * Handles the windowActivated event by invoking the windowActivated methods on listener-a and
   * listener-b.
   *
   * @param e the window event
   */
  ...
  /**
   * Handles the windowStateChanged event by invoking the windowStateChanged methods on listener-a
   * and listener-b.
   *
   * @param e the window event
   * @since 1.4
  ...
  /**
   * Handles the windowGainedFocus event by invoking the windowGainedFocus methods on listener-a and
   * listener-b.
   *
   * @param e the window event
   * @since 1.4
  ...
  /**
   * Handles the windowLostFocus event by invoking the windowLostFocus methods on listener-a and
   * listener-b.
   *
   * @param e the window event
   * @since 1.4
  ...
  /**
   * Handles the adjustmentValueChanged event by invoking the adjustmentValueChanged methods on
   * listener-a and listener-b.
   *
  ...
  /**
   * Handles the hierarchyChanged event by invoking the hierarchyChanged methods on listener-a and
   * listener-b.
   *
   * @param e the item event
   * @since 1.3
  ...
  /**
   * Handles the ancestorMoved event by invoking the ancestorMoved methods on listener-a and
   * listener-b.
   *
   * @param e the item event
   * @since 1.3
  ...
  /**
   * Handles the ancestorResized event by invoking the ancestorResized methods on listener-a and
   * listener-b.
   *
   * @param e the item event
   * @since 1.3
  ...
  /**
   * Handles the mouseWheelMoved event by invoking the mouseWheelMoved methods on listener-a and
   * listener-b.
   *
   * @param e the mouse event
   * @since 1.4
