...
/**
 * This class extends {@code DataBuffer} and stores data internally as integers.
 * <p>
...
public final class DataBufferInt extends DataBuffer {
  ...
  /**
   * Constructs an integer-based {@code DataBuffer} with a single bank and the specified size.
   *
  ...
  /**
   * Constructs an integer-based {@code DataBuffer} with the specified number of banks, all of which
  ...
  /**
   * Constructs an integer-based {@code DataBuffer} with a single bank using the specified array.
   * Only the first {@code size} elements should be used by accessors of this {@code DataBuffer}.
  ...
  /**
   * Constructs an integer-based {@code DataBuffer} with a single bank using the specified array,
   * size, and offset.  {@code dataArray} must have at least {@code offset} + {@code size} elements.
   * Only elements {@code offset} through {@code offset} + {@code size} - 1 should be used by
  ...
  /**
   * Constructs an integer-based {@code DataBuffer} with the specified arrays. The number of banks
   * will be equal to {@code dataArray.length}. Only the first {@code size} elements of each array
  ...
  /**
   * Constructs an integer-based {@code DataBuffer} with the specified arrays, size, and offsets.
  ...
  /**
   * Sets the requested data array element in the specified bank to the integer value {@code i}.
   *
