...
public final class DataBufferShort extends DataBuffer {
   ...
   * All data banks
   */
  final short[][] bankdata;

  /**
   * Constructs a short-based {@code DataBuffer} with a single bank and the specified size.
   *
  ...
  /**
   * Constructs a short-based {@code DataBuffer} with the specified number of banks all of which are
   * the specified size.
   *
  ...
  /**
   * Constructs a short-based {@code DataBuffer} with a single bank using the specified array. Only
  ...
  /**
   * Constructs a short-based {@code DataBuffer} with a single bank using the specified array, size,
  ...
  /**
   * Constructs a short-based {@code DataBuffer} with the specified arrays. The number of banks will
   * be equal to {@code dataArray.length}. Only the first {@code size} elements of each array should
  ...
  /**
   * Constructs a short-based {@code DataBuffer} with the specified arrays, size, and offsets. The
   * number of banks is equal to {@code dataArray.length}.  Each array must be at least as large as
   * {@code size} + the corresponding offset.   There must be an entry in the offset array for each
   * {@code dataArray} entry.  For each bank, only elements {@code offset} through {@code offset} +
   * {@code size} - 1 should be used by accessors of this {@code DataBuffer}.
   * <p>
   * Note that {@code DataBuffer} objects created by this constructor may be incompatible with <a
   * href="#optimizations">performance optimizations</a> used by some implementations (such as
   * caching an associated image in video memory).
