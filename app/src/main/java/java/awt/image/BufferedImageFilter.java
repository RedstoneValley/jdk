...
/**
 * The {@code BufferedImageFilter} class subclasses an {@code ImageFilter} to provide a simple means
 * of using a single-source/single-destination image operator ({@link BufferedImageOp}) to filter a
 * {@code BufferedImage} in the Image Producer/Consumer/Observer paradigm. Examples of these image
 * operators are: {@link ConvolveOp}, {@link AffineTransformOp} and {@link LookupOp}.
 *
 * @see ImageFilter
 * @see BufferedImage
 * @see BufferedImageOp
...
public class BufferedImageFilter extends ImageFilter {
  ...
  /**
   * Constructs a {@code BufferedImageFilter} with the specified single-source/single-destination
   * operator.
   *
   * @param op the specified {@code BufferedImageOp} to use to filter a {@code BufferedImage}
  ...
  /**
   * Filters the information provided in the {@link ImageConsumer#setDimensions(int, int)
   * setDimensions } method of the {@link ImageConsumer} interface.
   * <p>
   * Note: This method is intended to be called by the {@link ImageProducer} of the {@code Image}
   * whose pixels are being filtered. Developers using this class to retrieve pixels from an image
   * should avoid calling this method directly since that operation could result in problems with
   * retrieving the requested pixels.
   * <p>
   *
   * @param width the width to which to set the width of this {@code BufferedImageFilter}
   * @param height the height to which to set the height of this {@code BufferedImageFilter}
  ...
  /**
   * Filters the information provided in the {@link ImageConsumer#setColorModel(ColorModel)
   * setColorModel} method of the {@code ImageConsumer} interface.
   * <p>
   * If {@code model} is {@code null}, this method clears the current {@code ColorModel} of this
   ...
   * retrieving the requested pixels.
   *
   * @param model the {@link ColorModel} to which to set the {@code ColorModel} of this {@code
   * BufferedImageFilter}
  ...
  /**
   * Filters the information provided in the {@code setPixels} method of the {@code ImageConsumer}
  ...
  /**
   * Filters the information provided in the {@code imageComplete} method of the {@code
   ...
   * BufferedImageOp} associated with this instance.
