...
/**
 * This class handles the renderable aspects of an operation with help from its associated instance
...
public class RenderableImageOp implements RenderableImage {
  ...
  /**
   * Constructs a RenderedImageOp given a ContextualRenderedImageFactory object, and a
   * ParameterBlock containing RenderableImage sources and other parameters.  Any RenderedImage
   * sources referenced by the ParameterBlock will be ignored.
   *
   ...
   * may be used to determine whether an existing rendering may be cached and reused.  The CRIF's
  ...
  /**
   * Gets a RenderedImage instance of this image with a default width and height in pixels.  The
   * RenderContext is built automatically with an appropriate usr2dev transform and an area of
   * interest of the full image.  All the rendering hints come from hints passed in.  Implementors
   * of this interface must be sure that there is a defined default width and height.
   *
   * @return a RenderedImage containing the rendered data.
   */
  @Override
   ...
   * <p>
   * <ol> <li> mapRenderContext() is called on the associated CRIF for each RenderableImage source;
   * <li> createRendering() is called on each of the RenderableImage sources using the
   * backwards-mapped RenderContexts obtained in step 1, resulting in a rendering of each source;
   * <li> ContextualRenderedImageFactory.create() is called with a new ParameterBlock containing the
   * parameters of the RenderableImageOp and the RenderedImages that were created by the
   * createRendering() calls. </ol>
   * <p>
   ...
   * The effects of such a change will be visible when a new rendering is created from this
   * RenderableImageOp or any dependent RenderableImageOp.
   *
   ...
   *
   * @return the {@code ParameterBlock} of this {@code RenderableImageOp}.
