...
/**
 * The peer interface for {@link Frame}. This adds a couple of frame specific methods to the {@link
...
public interface FramePeer extends WindowPeer {
  ...
  /**
   * Sets the size and location for embedded frames. (On embedded frames, setLocation() and
   * setBounds() always set the frame to (0,0) for backwards compatibility.
   *
  ...
  /**
   * Returns the size and location for embedded frames. (On embedded frames, setLocation() and
   * setBounds() always set the frame to (0,0) for backwards compatibility.
   *
