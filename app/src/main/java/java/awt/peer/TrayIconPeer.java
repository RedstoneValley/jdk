...
/**
 * The peer interface for the {@link TrayIcon}. This doesn't need to be implemented if {@link
...
public interface TrayIconPeer {
  ...
  /**
   * Updates the icon image. This is supposed to display the current icon from the TrayIcon
   * component in the actual tray icon.
   *
