...
/**
 * RobotPeer defines an interface whereby toolkits support automated testing by allowing native
 * input events to be generated from Java code.
 * <p>
 * This interface should not be directly imported by code outside the java.awt.* hierarchy; it is
 * not to be considered public and is subject to change.
 *
 * @author Robi Khan
 */
