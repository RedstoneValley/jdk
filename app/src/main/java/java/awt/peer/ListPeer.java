...
public interface ListPeer extends ComponentPeer {
  ...
  /**
   * Returns the indices of the list items that are currently selected. The returned array is not
   * required to be a copy, the callers of this method already make sure it is not modified.
   *
  ...
  /**
   * Deletes items from the list. All items from start to end should are deleted, including the item
   * at the start and end indices.
   *
  ...
  /**
   * Makes sure that the item at the specified {@code index} is visible, by scrolling the list or
   * similar.
   *
