...
/**
 * A {@code Label} object is a component for placing text in a container. A label displays a single
 * line of read-only text. The text can be changed by the application, but a user cannot edit it
 * directly.
 * <p>
...
public class Label extends Component {
  ...
  /**
   * Constructs an empty label. The text of the label is the empty string {@code ""}.
   *
   ...
   *
   * @param text the string that the label presents. A {@code null} value will be accepted without
   ...
   * Possible values for {@code alignment} are {@code Label.LEFT}, {@code Label.RIGHT}, and {@code
   * Label.CENTER}.
   *
   * @param text the string that the label presents. A {@code null} value will be accepted without
   * causing a NullPointerException to be thrown.
  ...
  /**
   * Creates the peer for this label.  The peer allows us to modify the appearance of the label
  ...
  /**
   * Returns a string representing the state of this {@code Label}. This method is intended to be
  ...
  /**
   * Gets the current alignment of this label. Possible values are {@code Label.LEFT}, {@code
   * Label.RIGHT}, and {@code Label.CENTER}.
   *
  ...
  /**
   * Sets the alignment for this label to the specified alignment. Possible values are {@code
   * Label.LEFT}, {@code Label.RIGHT}, and {@code Label.CENTER}.
   *
   * @param alignment the alignment to be set.
   * @throws IllegalArgumentException if an improper value for {@code alignment} is given.
   ...
   *
   * @return the text of this label, or {@code null} if the text has been set to {@code null}.
   * @see Label#setText
   */
   ...
   *
   * @param text the text that this label displays. If {@code text} is {@code null}, it is treated
   * for display purposes like an empty string {@code ""}.
   * @see Label#getText
   */
