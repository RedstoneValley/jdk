...
/**
 * The {@code PageFormat} class describes the size and orientation of a page to be printed.
 */
public class PageFormat implements Cloneable {
 ...
 /* Class Constants */
  ...
  /**
   * The origin is at the bottom left of the paper with x running bottom to top and y running left
   * to right. Note that this is not the Macintosh landscape but is the Window's and PostScript
   * landscape.
   */
  public static final int LANDSCAPE = 0;

  /**
   * The origin is at the top left of the paper with x running to the right and y running down the
   * paper.
   */
  public static final int PORTRAIT = 1;

  /**
   * The origin is at the top right of the paper with x running top to bottom and y running right to
   * left. Note that this is the Macintosh landscape.
   */
 ...
 /* Instance Variables */
  ...
  /**
   * The orientation of the current page. This will be one of the constants: PORTRIAT, LANDSCAPE, or
   * REVERSE_LANDSCAPE,
   */
 ...
 /* Constructors */
  ...
  /**
   * Creates a default, portrait-oriented {@code PageFormat}.
   */
  public PageFormat() {
    mPaper = new Paper();
  }
 ...
 /* Instance Methods */
  ...
  /**
   * Makes a copy of this {@code PageFormat} with the same contents as this {@code PageFormat}.
   *
   ...
   * object associated with this {@code PageFormat}. This method takes into account the orientation
   * of the page.
   *
   * @return the x coordinate of the upper left point of the imageable area of the {@code Paper}
   * object associated with this {@code PageFormat}.
   */
  ...
  /**
   * Returns a copy of the {@link Paper} object associated with this {@code PageFormat}.  Changes
   * made to the {@code Paper} object returned from this method do not affect the {@code Paper}
   * object of this {@code PageFormat}.  To update the {@code Paper} object of this {@code
   * PageFormat}, create a new {@code Paper} object and set it into this {@code PageFormat} by using
   * the {@link #setPaper(Paper)} method.
   *
   * @return a copy of the {@code Paper} object associated with this {@code PageFormat}.
   * @see #setPaper
   */
  ...
  /**
   * Sets the {@code Paper} object for this {@code PageFormat}.
   *
   * @param paper the {@code Paper} object to which to set the {@code Paper} object for this {@code
   * PageFormat}.
  ...
  /**
   * Sets the page orientation. {@code orientation} must be one of the constants: PORTRAIT,
