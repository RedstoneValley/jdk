...
/**
 * The {@code Book} class provides a representation of a document in which pages may have different
 * page formats and page painters. This class uses the {@link Pageable} interface to interact with a
 * {@link PrinterJob}.
 *
 * @see Pageable
 * @see PrinterJob
...
public class Book implements Pageable {
 ...
 /* Instance Methods */
   ...
   *
   * @param pageIndex the zero based index of the page whose {@code PageFormat} is being requested
   * @return the {@code PageFormat} describing the size and orientation of the page.
   * @throws IndexOutOfBoundsException if the {@code Pageable} does not contain the requested page
   */
  @Override
  ...
  /**
   * Returns the {@link Printable} instance responsible for rendering the page specified by {@code
   * pageIndex}.
   *
   * @param pageIndex the zero based index of the page whose {@code Printable} is being requested
  ...
  /**
   * Sets the {@code PageFormat} and the {@code Painter} for a specified page number.
   *
   * @param pageIndex the zero based index of the page whose painter and format is altered
   * @param painter the {@code Printable} instance that renders the page
   * @param page the size and orientation of the page
   * @throws IndexOutOfBoundsException if the specified page is not already in this {@code Book}
   * @throws NullPointerException if the {@code painter} or {@code page} argument is {@code null}
   */
  ...
  /**
   * Appends {@code numPages} pages to the end of this {@code Book}.  Each of the pages is
   * associated with {@code page}.
   *
   * @param painter the {@code Printable} instance that renders the page
   * @param page the size and orientation of the page
   * @param numPages the number of pages to be added to the this {@code Book}.
   * @throws NullPointerException If the {@code painter} or {@code page} argument is {@code null}
   */
  ...
  /**
   * The BookPage inner class describes an individual page in a Book through a PageFormat-Printable
   * pair.
   */
  private class BookPage {
    ...
    /**
     * A new instance where 'format' describes the page's size and orientation and 'painter' is the
     * instance that will draw the page's graphics.
     *
     * @throws NullPointerException If the {@code painter} or {@code format} argument is {@code
     * null}
     */
