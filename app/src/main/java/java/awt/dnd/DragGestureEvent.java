...
/**
 * A {@code DragGestureEvent} is passed to {@code DragGestureListener}'s dragGestureRecognized()
 * method when a particular {@code DragGestureRecognizer} detects that a platform dependent drag
...
public class DragGestureEvent extends EventObject {
   ...
   * fields
   */
  @SuppressWarnings("rawtypes") private transient List events;
  /**
  ...
  /**
   * Constructs a {@code DragGestureEvent} object given by the {@code DragGestureRecognizer}
   * instance firing this event, an {@code act} parameter representing the user's preferred action,
   * an {@code ori} parameter indicating the origin of the drag, and a {@code List} of events that
   * comprise the gesture({@code evs} parameter).
   * <p>
   *
  ...
  public DragGestureEvent(
      DragGestureRecognizer dgr, int act, Point ori, List<? extends InputEvent> evs) {
    super(dgr);
  ...
  /**
   * Returns the {@code Component} associated with this {@code DragGestureEvent}.
   * <p>
   *
  ...
  /**
   * Returns a {@code Point} in the coordinates of the {@code Component} over which the drag
   * originated.
   * <p>
   *
  ...
  /**
   * Returns an {@code Object} array of the events comprising the drag gesture.
   * <p>
   *
  ...
  /**
   * Starts the drag operation given the {@code Cursor} for this drag operation and the {@code
   * Transferable} representing the source data for this drag operation. <br> If a {@code null}
   * {@code Cursor} is specified no exception will be thrown and default drag cursors will be used
   * instead. <br> If a {@code null} {@code Transferable} is specified {@code NullPointerException}
   * will be thrown.
   *
   ...
   * @param transferable The {@code Transferable} representing the source data for this drag
   * operation.
  ...
  /**
   * Starts the drag given the initial {@code Cursor} to display, the {@code Transferable} object,
  ...
  /**
   * Start the drag given the initial {@code Cursor} to display, a drag {@code Image}, the offset of
   * the {@code Image}, the {@code Transferable} object, and the {@code DragSourceListener} to use.
   * <p>
   *
   * @param dragCursor The initial {@code Cursor} for this drag operation or {@code null} for the
   * default cursor handling; see <a href="DragSourceContext.html#defaultCursor">DragSourceContext</a>
  ...
  public void startDrag(
      Cursor dragCursor, Image dragImage, Point imageOffset, Transferable transferable,
  ...
  /**
   * Serializes this {@code DragGestureEvent}. Performs default serialization and then writes out
   * this object's {@code List} of gesture events if and only if the {@code List} can be serialized.
   * If not, {@code null} is written instead. In this case, a {@code DragGestureEvent} created from
   * the resulting deserialized stream will contain an empty {@code List} of gesture events.
   *
   * @serialData The default serializable fields, in alphabetical order, followed by either a {@code
   * List} instance, or {@code null}.
   * @since 1.4
   */
  ...
  /**
   * Deserializes this {@code DragGestureEvent}. This method first performs default deserialization
   * for all non-{@code transient} fields. An attempt is then made to deserialize this object's
   * {@code List} of gesture events as well. This is first attempted by deserializing the field
   * {@code events}, because, in releases prior to 1.4, a non-{@code transient} field of this name
   * stored the {@code List} of gesture events. If this fails, the next object in the stream is used
   * instead. If the resulting {@code List} is {@code null}, this object's {@code List} of gesture
   * events is set to an empty {@code List}.
   *
   * @since 1.4
   */
