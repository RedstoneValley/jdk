...
/**
 * The {@code MenuBar} class encapsulates the platform's concept of a menu bar bound to a frame. In
 * order to associate the menu bar with a {@code Frame} object, call the frame's {@code setMenuBar}
 * method.
 * <p>
 * <A NAME="mbexample"></A><!-- target for cross references --> This is what a menu bar might look
 * like:
 * <p>
 * <img src="doc-files/MenuBar-1.gif" alt="Diagram of MenuBar containing 2 menus: Examples and
 * Options. Examples menu is expanded showing items: Basic, Simple, Check, and More Examples."
 ...
 * instance of {@code MenuShortcut}. The {@code MenuBar} class defines several methods, {@link
 * MenuBar#shortcuts} and {@link MenuBar#getShortcutMenuItem} that retrieve information about the
 * shortcuts a given menu bar is managing.
 *
 * @author Sami Shaio
 * @see Frame
...
public class MenuBar extends MenuComponent implements MenuContainer {
  ...
  /**
   * This menu is a special menu dedicated to help.  The one thing to note about this menu is that
   * on some platforms it appears at the right edge of the menubar.
   *
   * @serial
   * @see #getHelpMenu()
  ...
  /**
   * Removes the menu bar's peer.  The peer allows us to change the appearance of the menu bar
   * without changing any of the menu bar's functionality.
   */
  @Override
  ...
  /**
   * Gets the AccessibleContext associated with this MenuBar. For menu bars, the AccessibleContext
   * takes the form of an AccessibleAWTMenuBar. A new AccessibleAWTMenuBar instance is created if
   * necessary.
   *
  ...
  /**
   * Creates the menu bar's peer.  The peer allows us to change the appearance of the menu bar
   * without changing any of the menu bar's functionality.
   */
  ...
  /**
   * Sets the specified menu to be this menu bar's help menu. If this menu bar has an existing help
   * menu, the old help menu is removed from the menu bar, and replaced with the specified menu.
   *
  ...
  /**
   * Adds the specified menu to the menu bar. If the menu has been part of another menu bar, removes
   * it from that menu bar.
   *
  ...
  /**
   * @deprecated As of JDK version 1.1, replaced by {@code getMenuCount()}.
   */
  @Deprecated
  ...
  /**
   * Gets the instance of {@code MenuItem} associated with the specified {@code MenuShortcut}
   * object, or {@code null} if none of the menu items being managed by this menu bar is associated
   * with the specified menu shortcut.
   *
  ...
  /**
   * Inner class of MenuBar used to provide default support for accessibility.  This class is not
   ...
   * <p>
   * This class implements accessibility support for the {@code MenuBar} class.  It provides an
   * implementation of the Java Accessibility API appropriate to menu bar user-interface elements.
   *
   * @since 1.3
   */
