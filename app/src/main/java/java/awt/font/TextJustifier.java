...
class TextJustifier {
  ...
  /**
   * Initialize the justifier with an array of infos corresponding to each glyph. Start and limit
   * indicate the range of the array to examine.
   */
  ...
  /**
   * Return an array of deltas twice as long as the original info array, indicating the amount by
   * which each side of each glyph should grow or shrink.
   * <p>
