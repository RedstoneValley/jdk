...
/**
 * The interface for objects which have an adjustable numeric value contained within a bounded range
 * of values.
 *
 * @author Amy Fowler
 * @author Tim Prinzing
...
public interface Adjustable {
   ...
   *
   * @return the orientation of the adjustable object; either {@code HORIZONTAL}, {@code VERTICAL},
  ...
  /**
   * Sets the current value of the adjustable object. If the value supplied is less than {@code
   * minimum} or greater than {@code maximum} - {@code visibleAmount}, then one of those values is
   * substituted, as appropriate.
   * <p>
   * Calling this method does not fire an {@code AdjustmentEvent}.
   *
   * @param v the current value, between {@code minimum} and {@code maximum} - {@code
   * visibleAmount}
   */
  void setValue(int v);
