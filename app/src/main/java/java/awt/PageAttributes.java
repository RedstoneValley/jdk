 ...
 * <p>
 * Instances of this class control the color state, paper size (media type), orientation, logical
 * origin, print quality, and resolution of every page which uses the instance. Attribute names are
 * compliant with the Internet Printing Protocol (IPP) 1.1 where possible. Attribute values are
 ...
 * of those classes has a public constructor. For example, to set the color state to monochrome, use
 * the following code:
 * <pre>
...
public final class PageAttributes implements Cloneable {
   ...
   * 0. The second element must be must be greater than 0. The third element must be either {@code
   * 3} or {@code 4}.
   * @throws IllegalArgumentException if one or more of the above conditions is violated.
   */
  public PageAttributes(
      ColorType color, MediaType media, OrientationRequestedType orientationRequested,
  ...
  /**
   * Returns whether pages using these attributes will be rendered in color or monochrome. This
  ...
  /**
   * Specifies whether pages using these attributes will be rendered in color or monochrome. Not
   * specifying this attribute is equivalent to specifying ColorType.MONOCHROME.
   *
   * @param color ColorType.COLOR or ColorType.MONOCHROME.
  ...
  /**
   * Returns the paper size for pages using these attributes. This attribute is updated to the value
   * chosen by the user.
   *
  ...
  /**
   * Specifies the desired paper size for pages using these attributes. The actual paper size will
   * be determined by the limitations of the target printer. If an exact match cannot be found, an
   * implementation will choose the closest possible match. Not specifying this attribute is
   * equivalent to specifying the default size for the default locale. The default size for locales
   * in the United States and Canada is MediaType.NA_LETTER. The default size for all other locales
   * is MediaType.ISO_A4.
   *
   * @param media one of the constant fields of the MediaType class.
  ...
  /**
   * Sets the paper size for pages using these attributes to the default size for the default
   * locale. The default size for locales in the United States and Canada is MediaType.NA_LETTER.
   * The default size for all other locales is MediaType.ISO_A4.
   */
  ...
  /**
   * Returns the print orientation for pages using these attributes. This attribute is updated to
  ...
  /**
   * Specifies the print orientation for pages using these attributes. Specifying {@code 3} denotes
   * portrait. Specifying {@code 4} denotes landscape. Specifying any other value will generate an
   * IllegalArgumentException. Not specifying the property is equivalent to calling
   * setOrientationRequested(OrientationRequestedType.PORTRAIT).
   *
   * @param orientationRequested {@code 3} or {@code 4}
   * @throws IllegalArgumentException if orientationRequested is not {@code 3} or {@code 4}
   */
  ...
  /**
   * Specifies the print orientation for pages using these attributes. Not specifying the property
   * is equivalent to specifying OrientationRequestedType.PORTRAIT.
   *
   * @param orientationRequested OrientationRequestedType.PORTRAIT or
   * OrientationRequestedType.LANDSCAPE.
  ...
  /**
   * Sets the print orientation for pages using these attributes to the default. The default
  ...
  /**
   * Returns whether drawing at (0, 0) to pages using these attributes draws at the upper-left
   * corner of the physical page, or at the upper-left corner of the printable area. (Note that
   * these locations could be equivalent.) This attribute cannot be modified by, and is not subject
  ...
  /**
   * Specifies whether drawing at (0, 0) to pages using these attributes draws at the upper-left
   * corner of the physical page, or at the upper-left corner of the printable area. (Note that
   * these locations could be equivalent.) Not specifying the property is equivalent to specifying
   * OriginType.PHYSICAL.
   *
   * @param origin OriginType.PHYSICAL or OriginType.PRINTABLE
  ...
  /**
   * Returns the print quality for pages using these attributes. This attribute is updated to the
  ...
  /**
   * Specifies the print quality for pages using these attributes. Specifying {@code 3} denotes
   * draft. Specifying {@code 4} denotes normal. Specifying {@code 5} denotes high. Specifying any
   * other value will generate an IllegalArgumentException. Not specifying the property is
   * equivalent to calling setPrintQuality(PrintQualityType.NORMAL).
   *
   * @param printQuality {@code 3}, {@code 4}, or {@code 5}
   * @throws IllegalArgumentException if printQuality is not {@code 3 }, {@code 4}, or {@code 5}
   */
  ...
  /**
   * Specifies the print quality for pages using these attributes. Not specifying the property is
   * equivalent to specifying PrintQualityType.NORMAL.
   *
   * @param printQuality PrintQualityType.DRAFT, PrintQualityType.NORMAL, or PrintQualityType.HIGH
  ...
  /**
   * Sets the print quality for pages using these attributes to the default. The default print
   * quality is normal.
   */
  ...
  /**
   * Returns the print resolution for pages using these attributes. Index 0 of the array specifies
   * the cross feed direction resolution (typically the horizontal resolution). Index 1 of the array
   * specifies the feed direction resolution (typically the vertical resolution). Index 2 of the
   * array specifies whether the resolutions are in dots per inch or dots per centimeter. {@code 3}
   * denotes dots per inch. {@code 4} denotes dots per centimeter.
   *
   * @return an integer array of 3 elements. The first element must be greater than 0. The second
   * element must be must be greater than 0. The third element must be either {@code 3} or {@code
   * 4}.
   */
  ...
  /**
   * Specifies the desired cross feed and feed print resolutions in dots per inch for pages using
   * these attributes. The same value is used for both resolutions. The actual resolutions will be
   * determined by the limitations of the implementation and the target printer. Not specifying the
   * property is equivalent to specifying {@code 72}.
   *
  ...
  /**
   * Specifies the desired print resolution for pages using these attributes. The actual resolution
   * will be determined by the limitations of the implementation and the target printer. Index 0 of
   * the array specifies the cross feed direction resolution (typically the horizontal resolution).
   * Index 1 of the array specifies the feed direction resolution (typically the vertical
   * resolution). Index 2 of the array specifies whether the resolutions are in dots per inch or
   * dots per centimeter. {@code 3} denotes dots per inch. {@code 4} denotes dots per centimeter.
   * Note that the 1.1 printing implementation (Toolkit.getPrintJob) requires that the feed and
   * cross feed resolutions be the same. Not specifying the property is equivalent to calling
  ...
  /**
   * Sets the printer resolution for pages using these attributes to the default. The default is 72
   * dpi for both the feed and cross feed resolutions.
   */
   ...
   * <p>
   * Two PageAttributes are equal if and only if each of their attributes are equal. Attributes of
   * enumeration type are equal if and only if the fields refer to the same unique enumeration
   * object. This means that an aliased media is equal to its underlying unique media. Printer
   * resolutions are equal if and only if the feed resolution, cross feed resolution, and units are
   * equal.
   *
  ...
  public static final class MediaType extends AttributeValue {
    ...
    private static final String[] NAMES = {
        ...
        "jis-b3", "jis-b4", "jis-b5", "jis-b6", "jis-b7", "jis-b8", "jis-b9", "jis-b10", "iso-c0",
        "iso-c1", "iso-c2", "iso-c3", "iso-c4", "iso-c5", "iso-c6", "iso-c7", "iso-c8", "iso-c9",
        "iso-c10", "iso-designated-long", "executive", "folio", "invoice", "ledger", "na-letter",
        "na-legal", "quarto", "a", "b", "c", "d", "e", "na-10x15-envelope", "na-10x14-envelope",
        "na-10x13-envelope", "na-9x12-envelope", "na-9x11-envelope", "na-7x9-envelope",
        "na-6x9-envelope", "na-number-9-envelope", "na-number-10-envelope", "na-number-11-envelope",
        "na-number-12-envelope", "na-number-14-envelope", "invite-envelope", "italy-envelope",
  ...
  /**
   * A type-safe enumeration of possible orientations. These orientations are in partial compliance
   * with IPP 1.1.
   *
   * @since 1.3
   */
  ...
  /**
   * A type-safe enumeration of possible print qualities. These print qualities are in compliance
   * with IPP 1.1.
   *
   * @since 1.3
   */
