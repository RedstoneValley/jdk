...
/**
 * The {@code LinearGradientPaint} class provides a way to fill a {@link Shape} with a linear color
 * gradient pattern.  The user may specify two or more gradient colors, and this paint will provide
 * an interpolation between each color.  The user also specifies start and end points which define
 * where in user space the color gradient should begin and end.
 * <p>
 ...
 * <p>
 * <p>
 * The user may also select what action the {@code LinearGradientPaint} object takes when it is
 * filling the space outside the start and end points by setting {@code CycleMethod} to either
 * {@code REFLECTION} or {@code REPEAT}. The distances between any two colors in any of the
 * reflected or repeated copies of the gradient are the same as the distance between those same two
 * colors between the start and end points. Note that some minor variations in distances may occur
 * due to sampling at the granularity of a pixel. If no cycle method is specified, {@code NO_CYCLE}
 * will be chosen by default, which means the endpoint colors will be used to fill the remaining
 * area.
 * <p>
 ...
 * </pre>
 * <p>
 * This code will create a {@code LinearGradientPaint} which interpolates between red and white for
 * the first 20% of the gradient and between white and blue for the remaining 80%.
 * <p>
 * <p>
 * This image demonstrates the example code above for each of the three cycle methods: <center> <img
 * src = "doc-files/LinearGradientPaint.png" alt="image showing the output of the example code">
 * </center>
 *
...
public final class LinearGradientPaint extends MultipleGradientPaint {
  ...
  /**
   * Constructs a {@code LinearGradientPaint} with a default {@code NO_CYCLE} repeating method and
   ...
   * See the {@link Paint#createContext specification} of the method in the {@link Paint} interface
