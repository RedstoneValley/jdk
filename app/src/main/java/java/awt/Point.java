...
public class Point extends Point2D implements Serializable {
  ...
  /**
   * The X coordinate of this {@code Point}. If no X coordinate is set it will default to 0.
   *
   * @serial
   * @see #getLocation()
   * @see #move(int, int)
  ...
  public int x;
  /**
   * The Y coordinate of this {@code Point}. If no Y coordinate is set it will default to 0.
   *
   * @serial
   * @see #getLocation()
   * @see #move(int, int)
  ...
  /**
   * Constructs and initializes a point with the same location as the specified {@code Point}
   * object.
   *
   * @param p a point
   * @since 1.1
  ...
  /**
   * Sets the location of this point to the specified double coordinates. The double values will be
   * rounded to integer values. Any number smaller than {@code Integer.MIN_VALUE} will be reset to
   * {@code MIN_VALUE}, and any number larger than {@code Integer.MAX_VALUE} will be reset to {@code
   * MAX_VALUE}.
   *
  ...
  /**
   * Sets the location of the point to the specified location. This method is included for
   * completeness, to parallel the {@code setLocation} method of {@code Component}.
   *
   ...
   * Component}. Its behavior is identical with {@code move(int,&nbsp;int)}.
   *
   * @param x the X coordinate of the new location
   * @param y the Y coordinate of the new location
   ...
   * is identical with {@code setLocation(int,&nbsp;int)}.
   *
   * @param x the X coordinate of the new location
   * @param y the Y coordinate of the new location
   * @see Component#setLocation(int, int)
