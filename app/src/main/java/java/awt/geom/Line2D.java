...
/**
 * This {@code Line2D} represents a line segment in {@code (x,y)} coordinate space.  This class,
 * like all of the Java 2D API, uses a default coordinate system called <i>user space</i> in which
 * the y-axis values increase downward and x-axis values increase to the right.  For more
 * information on the user space coordinate system, see the <a href="http://docs.oracle.com/javase/1.3/docs/guide/2d/spec/j2d-intro.fm2.html#61857">
 * Coordinate Systems</a> section of the Java 2D Programmer's Guide.
 * <p>
 * This class is only the abstract superclass for all objects that store a 2D line segment. The
...
public abstract class Line2D implements Shape, Cloneable {
   ...
   * information necessary to satisfy the various accessory methods below.
   *
   * @see Float
   * @see Double
   * @since 1.2
   ...
   * (x1,y1)}, in order to point at the specified point {@code (px,py)}. <p>A return value of 1
   * indicates that the line segment must turn in the direction that takes the positive X axis
   * towards the negative Y axis.  In the default coordinate system used by Java 2D, this direction
   * is counterclockwise. <p>A return value of -1 indicates that the line segment must turn in the
   * direction that takes the positive X axis towards the positive Y axis.  In the default
   * coordinate system, this direction is clockwise. <p>A return value of 0 indicates that the point
   * lies exactly on the line segment.  Note that an indicator value of 0 is rare and not useful for
   * determining collinearity because of floating point rounding issues. <p>If the point is colinear
   * with the line segment, but not between the end points, then the value will be -1 if the point
   ...
   * @return {@code true} if the first specified line segment and the second specified line segment
   ...
   * specified point intersects the line segment in between the end points, this method returns
   * 0.0.
   *
   * @param x1 the X coordinate of the start point of the specified line segment
   * @param y1 the Y coordinate of the start point of the specified line segment
  ...
  /**
   * Sets the location of the end points of this {@code Line2D} to the specified double
   * coordinates.
   *
  ...
  /**
   * Sets the location of the end points of this {@code Line2D} to the specified {@code Point2D}
   * coordinates.
   *
  ...
  /**
   * Sets the location of the end points of this {@code Line2D} to the same as those end points of
   * the specified {@code Line2D}.
   *
   ...
   *
   * @param px the X coordinate of the specified point to be compared with this {@code Line2D}
   * @param py the Y coordinate of the specified point to be compared with this {@code Line2D}
  ...
  /**
   * Returns an indicator of where the specified {@code Point2D} lies with respect to this line
   * segment. See the method comments of {@link #relativeCCW(double, double, double, double, double,
   * double)} to interpret the return value.
   *
   * @param p the specified {@code Point2D} to be compared with this {@code Line2D}
   * @return an integer that indicates the position of the specified {@code Point2D} with respect to
   * this {@code Line2D}
   * @see #relativeCCW(double, double, double, double, double, double)
   * @since 1.2
   */
  ...
  /**
   * Tests if the line segment from {@code (x1,y1)} to {@code (x2,y2)} intersects this line
   * segment.
   *
   * @param x1 the X coordinate of the start point of the specified line segment
   * @param y1 the Y coordinate of the start point of the specified line segment
   ...
   *
   * @param l the specified {@code Line2D}
   * @return {@code true} if this line segment and the specified line segment intersect each other;
   * {@code false} otherwise.
   * @since 1.2
   */
  public boolean intersectsLine(Line2D l) {
    return linesIntersect(l.getX1(),
        l.getY1(),
        l.getX2(),
        l.getY2(),
        getX1(),
  ...
  /**
   * Returns the square of the distance from a {@code Point2D} to this line segment. The distance
   * measured is the distance between the specified point and the closest point between the current
   * line's end points. If the specified point intersects the line segment in between the end
   * points, this method returns 0.0.
   *
   * @param pt the specified {@code Point2D} being measured against this line segment.
   * @return a double value that is the square of the distance from the specified {@code Point2D} to
  ...
  /**
   * Returns the distance from a {@code Point2D} to this line segment. The distance measured is the
   * distance between the specified point and the closest point between the current line's end
   * points. If the specified point intersects the line segment in between the end points, this
   * method returns 0.0.
   *
   * @param pt the specified {@code Point2D} being measured against this line segment
   * @return a double value that is the distance from the specified {@code Point2D} to the current
   * line segment.
   ...
   * distance between the specified point and the closest point on the infinitely-extended line
   * defined by this {@code Line2D}.  If the specified point intersects the line, this method
   * returns 0.0.
   *
  ...
  /**
   * Returns the square of the distance from a specified {@code Point2D} to this line. The distance
   * measured is the distance between the specified point and the closest point on the
   * infinitely-extended line defined by this {@code Line2D}.  If the specified point intersects the
   * line, this method returns 0.0.
   *
   * @param pt the specified {@code Point2D} being measured against this line
   * @return a double value that is the square of the distance from a specified {@code Point2D} to
   * the current line.
   ...
   * {@code Line2D}.  If the specified point intersects the line, this method returns 0.0.
   *
   * @param px the X coordinate of the specified point being measured against this line
   * @param py the Y coordinate of the specified point being measured against this line
  ...
  /**
   * Returns the distance from a {@code Point2D} to this line. The distance measured is the distance
   * between the specified point and the closest point on the infinitely-extended line defined by
   * this {@code Line2D}.  If the specified point intersects the line, this method returns 0.0.
   *
   * @param pt the specified {@code Point2D} being measured
   * @return a double value that is the distance from a specified {@code Point2D} to the current
   * line.
  ...
  public static class Float extends Line2D implements Serializable {
    ...
    /**
     * Sets the location of the end points of this {@code Line2D} to the specified float
     * coordinates.
     *
     * @param x1 the X coordinate of the start point
     * @param y1 the Y coordinate of the start point
  ...
  /**
   * Tests if a specified coordinate is inside the boundary of this {@code Line2D}.  This method is
   * required to implement the {@link Shape} interface, but in the case of {@code Line2D} objects it
  ...
  /**
   * Tests if a given {@code Point2D} is inside the boundary of this {@code Line2D}. This method is
   * required to implement the {@link Shape} interface, but in the case of {@code Line2D} objects it
   * always returns {@code false} since a line contains no area.
   *
  ...
  /**
   * Tests if the interior of this {@code Line2D} entirely contains the specified set of rectangular
   * coordinates. This method is required to implement the {@code Shape} interface, but in the case
   * of {@code Line2D} objects it always returns false since a line contains no area.
   *
  ...
  /**
   * Tests if the interior of this {@code Line2D} entirely contains the specified {@code
   * Rectangle2D}. This method is required to implement the {@code Shape} interface, but in the case
   * of {@code Line2D} objects it always returns {@code false} since a line contains no area.
   *
  ...
  /**
   * Returns an iteration object that defines the boundary of this {@code Line2D}. The iterator for
   * this class is not multi-threaded safe, which means that this {@code Line2D} class does not
   * guarantee that modifications to the geometry of this {@code Line2D} object do not affect any
   * iterations of that geometry that are already in process.
   *
   * @param at the specified {@link AffineTransform}
   * @return a {@link PathIterator} that defines the boundary of this {@code Line2D}.
   * @since 1.2
   */
  @Override
  ...
  /**
   * Returns an iteration object that defines the boundary of this flattened {@code Line2D}. The
   * iterator for this class is not multi-threaded safe, which means that this {@code Line2D} class
   * does not guarantee that modifications to the geometry of this {@code Line2D} object do not
   ...
   * Since a {@code Line2D} object is always flat, this parameter is ignored.
   * @return a {@code PathIterator} that defines the boundary of the flattened {@code Line2D}
   * @since 1.2
   */
  @Override
