...
/**
 * {@code Arc2D} is the abstract superclass for all objects that store a 2D arc defined by a framing
 * rectangle, start angle, angular extent (length of the arc), and a closure type ({@code OPEN},
 * {@code CHORD}, or {@code PIE}).
 * <p>
 * <a name="inscribes"> The arc is a partial section of a full ellipse which inscribes the framing
 * rectangle of its parent {@link RectangularShape}. </a> <a name="angles"> The angles are specified
 * relative to the non-square framing rectangle such that 45 degrees always falls on the line from
 * the center of the ellipse to the upper right corner of the framing rectangle. As a result, if the
 * framing rectangle is noticeably longer along one axis than the other, the angles to the start and
 * end of the arc segment will be skewed farther along the longer axis of the frame. </a>
 * <p>
...
public abstract class Arc2D extends RectangularShape {
   ...
   * <p>
   * This constructor creates an object with a default closure type of {@link #OPEN}.  It is
   * provided only to enable serialization of subclasses.
   *
   * @see Float
   * @see Double
   */
  ...
  /**
   * Sets the closure type of this arc to the specified value: {@code OPEN}, {@code CHORD}, or
   * {@code PIE}.
   *
   * @param type The integer constant that represents the closure type of this arc: {@link #OPEN},
   * {@link #CHORD}, or {@link #PIE}.
   * @throws IllegalArgumentException if {@code type} is not 0, 1, or 2.+
   * @see #getArcType
   * @since 1.2
   */
   ...
   *
   * @return A {@code Point2D} object representing the x,y coordinates of the starting point of the
   * arc.
   * @since 1.2
   */
   ...
   * the arc.
   *
   * @return A {@code Point2D} object representing the x,y coordinates  of the ending point of the
   * arc.
   * @since 1.2
   */
   ...
   * values.
   *
   * @param loc The {@code Point2D} representing the coordinates of the upper-left corner of the
   * arc.
   * @param size The {@code Dimension2D} representing the width and height of the full ellipse of
   ...
   * point.
   *
   * @param p1 The {@code Point2D} that defines the arc's starting point.
   * @param p2 The {@code Point2D} that defines the arc's ending point.
   * @since 1.2
   */
  @SuppressWarnings("unused")
   ...
   * the part of this {@code Arc2D} that is in between the starting and ending angles and contains
   * the pie wedge, if this {@code Arc2D} has a {@code PIE} closure type.
   * <p>
   * This method differs from the {@link RectangularShape#getBounds() getBounds} in that the {@code
   * getBounds} method only returns the bounds of the enclosing ellipse of this {@code Arc2D}
   * without considering the starting and ending angles of this {@code Arc2D}.
   *
   * @return the {@code Rectangle2D} that represents the arc's framing rectangle.
   * @since 1.2
   */
  @Override
   ...
   * @return {@code true} if the point lies within the bound of the arc, {@code false} if the point
   * lies outside of the arc's bounds.
   * @since 1.2
   */
  @Override
   ...
   * @return {@code true} if the arc intersects the rectangle, {@code false} if the arc doesn't
   ...
   * @param w The width of the rectangle.
   * @param h The height of the rectangle.
   * @return {@code true} if the arc contains the rectangle, {@code false} if the arc doesn't
  ...
  /**
   * Returns an iteration object that defines the boundary of the arc. This iterator is multithread
   * safe. {@code Arc2D} guarantees that modifications to the geometry of the arc do not affect any
  ...
  /**
   * Constructs a {@code Rectangle2D} of the appropriate precision to hold the parameters calculated
   * to be the framing rectangle of this arc.
   *
   ...
   * @return a {@code Rectangle2D} that is the framing rectangle of this arc.
   * @since 1.2
   */
   ...
   * @return {@code true} if the arc contains the angle, {@code false} if the arc doesn't contain
   * the angle.
   * @since 1.2
   */
  ...
  /**
   * Determines whether or not the specified {@code Object} is equal to this {@code Arc2D}.  The
   * specified {@code Object} is equal to this {@code Arc2D} if it is an instance of {@code Arc2D}
   * and if its location, size, arc extents and type are the same as this {@code Arc2D}.
   *
   * @param obj an {@code Object} to be compared with this {@code Arc2D}.
   * @return {@code true} if {@code obj} is an instance of {@code Arc2D} and has the same values;
  ...
  public static class Float extends Arc2D implements Serializable {
    ...
    public float y;
    /**
     * The overall width of the full ellipse of which this arc is a partial section (not considering
     * the angular extents).
     *
     * @serial
     * @since 1.2
    ...
    public float width;
    /**
     * The overall height of the full ellipse of which this arc is a partial section (not
     * considering the angular extents).
     *
     * @serial
     * @since 1.2
     */
    ...
    /**
     * Constructs a new arc, initialized to location (0, 0), size (0, 0), angular extents (start =
     * 0, extent = 0), and the specified closure type.
     *
    ...
    /**
     * Writes the default serializable fields to the {@code ObjectOutputStream} followed by a byte
     * indicating the arc type of this {@code Arc2D} instance.
     *
     * @serialData <ol> <li>The default serializable fields. <li> followed by a {@code byte}
    ...
    /**
     * Reads the default serializable fields from the {@code ObjectInputStream} followed by a byte
     * indicating the arc type of this {@code Arc2D} instance.
     *
     * @serialData <ol> <li>The default serializable fields. <li> followed by a {@code byte}
     * indicating the arc type {@link #OPEN}, {@link #CHORD}, or {@link #PIE}. </ol>
