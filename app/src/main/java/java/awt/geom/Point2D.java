...
/**
 * The {@code Point2D} class defines a point representing a location in {@code (x,y)} coordinate
 * space.
 * <p>
...
public abstract class Point2D implements Cloneable {
  ...
  /**
   * Sets the location of this {@code Point2D} to the specified {@code double} coordinates.
   *
  ...
  /**
   * Sets the location of this {@code Point2D} to the same coordinates as the specified {@code
   * Point2D} object.
   *
  ...
  /**
   * Returns the square of the distance from this {@code Point2D} to a specified point.
   *
   * @param px the X coordinate of the specified point to be measured against this {@code Point2D}
   * @param py the Y coordinate of the specified point to be measured against this {@code Point2D}
   * @return the square of the distance between this {@code Point2D} and the specified point.
   * @since 1.2
   */
  ...
  /**
   * Returns the square of the distance from this {@code Point2D} to a specified {@code Point2D}.
   *
   * @param pt the specified point to be measured against this {@code Point2D}
   * @return the square of the distance between this {@code Point2D} to a specified {@code Point2D}.
   * @since 1.2
   */
  ...
  /**
   * Returns the distance from this {@code Point2D} to a specified {@code Point2D}.
   *
   * @param pt the specified point to be measured against this {@code Point2D}
   * @return the distance between this {@code Point2D} and the specified {@code Point2D}.
   * @since 1.2
   */
  ...
  /**
   * Determines whether or not two points are equal. Two instances of {@code Point2D} are equal if
   * the values of their {@code x} and {@code y} member fields, representing their position in the
   * coordinate space, are the same.
   *
   * @param obj an object to be compared with this {@code Point2D}
   * @return {@code true} if the object to be compared is an instance of {@code Point2D} and has the
   * same values; {@code false} otherwise.
   * @since 1.2
   */
  ...
  public static class Float extends Point2D implements Serializable {
    ...
    /**
     * Sets the location of this {@code Point2D} to the specified {@code float} coordinates.
     *
     * @param x the new X coordinate of this {@code Point2D}
     * @param y the new Y coordinate of this {@code Point2D}
     * @since 1.2
  ...
  /**
   * The {@code Double} class defines a point specified in {@code double} precision.
   *
   * @since 1.2
   */
