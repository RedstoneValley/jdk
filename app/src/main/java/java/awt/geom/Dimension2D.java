...
public abstract class Dimension2D implements Cloneable {
  ...
  /**
   * Returns the width of this {@code Dimension} in double precision.
   *
  ...
  /**
   * Returns the height of this {@code Dimension} in double precision.
   *
   ...
   * is included for completeness, to parallel the {@link java.awt.Component#getSize getSize} method
  ...
  /**
   * Sets the size of this {@code Dimension2D} object to match the specified size. This method is
   * included for completeness, to parallel the {@code getSize} method of {@code Component}.
   *
   * @param d the new size for the {@code Dimension2D} object
   * @since 1.2
   */
