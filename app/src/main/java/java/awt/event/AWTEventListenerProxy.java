...
/**
 * A class which extends the {@code EventListenerProxy} specifically for adding an {@code
 * AWTEventListener} for a specific event mask. Instances of this class can be added as {@code
 * AWTEventListener}s to a {@code Toolkit} object.
 * <p>
 * The {@code getAWTEventListeners} method of {@code Toolkit} can return a mixture of {@code
 * AWTEventListener} and {@code AWTEventListenerProxy} objects.
 *
