 ...
 * FocusEvent, WindowEvent, ContainerEvent), this class defines the events that indicate changes in
 ...
 * moved, resized, rendered invisible, or made visible again. The event is passed to every {@code
 * ComponentListener} or {@code ComponentAdapter} object which registered to receive such events
 * using the component's {@code addComponentListener} method. ({@code ComponentAdapter} objects
 * implement the {@code ComponentListener} interface.) Each such listener object gets this {@code
 ...
 * ComponentEvent} instance is not in the range from {@code COMPONENT_FIRST} to {@code
 * COMPONENT_LAST}.
 *
 * @author Carl Quinn
...
public class ComponentEvent extends AWTEvent {
  ...
  /**
   * Constructs a {@code ComponentEvent} object. <p> This method throws an {@code
