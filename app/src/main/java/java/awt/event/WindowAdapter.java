 ...
 * <p>
 * Extend this class to create a {@code WindowEvent} listener and override the methods for the
 * events of interest. (If you implement the {@code WindowListener} interface, you have to define
 ...
 * <p>
 * Create a listener object using the extended class and then register it with a Window using the
 * window's {@code addWindowListener} method. When the window's status changes by virtue of being
 * opened, closed, activated or deactivated, iconified or deiconified, the relevant method in the
 * listener object is invoked, and the {@code WindowEvent} is passed to it.
 *
 * @author Carl Quinn
 * @author Amy Fowler
